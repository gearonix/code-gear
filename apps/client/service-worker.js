...
class Oe {
  ...
  async cachePut(e, t) {
    ...
    if (!a)
      return !1;
    const { cacheName: o, matchOptions: i } = this._strategy, c = await self.caches.open(o), l = this.hasCallback("cacheDidUpdate"), m = l ? await be(
