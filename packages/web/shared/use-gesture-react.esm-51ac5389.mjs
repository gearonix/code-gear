...
function H(s, t, e, i = 0.15) {
  return i === 0 ? _t(s, t, e) : s < t ? -j(t - s, e - t, i) + t : s > e ? +j(s - e, e - t, i) + e : s;
}
function vt(s, [t, e], [i, n]) {
  const [[r, o], [c, l]] = s;
  return [H(t, r, o, i), H(e, c, l, n)];
}
function yt(s, t) {
...
function f(s) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? U(Object(e), !0).forEach(function(i) {
      d(s, i, e[i]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(s, Object.getOwnPropertyDescriptors(e)) : U(Object(e)).forEach(function(i) {
...
class S extends et {
  ...
  axisIntent(t) {
    const e = this.state, i = this.config;
    if (!e.axis && t) {
      const n = typeof i.axisThreshold == "object" ? i.axisThreshold[Z(t)] : i.axisThreshold;
...
function Ht() {
  return it() || I && window.navigator.maxTouchPoints > 1;
}
function Ut() {
...
const m = {
  ...
  pointer: Ut(),
  pointerLock: Yt()
}, Nt = 250, Xt = 180, Wt = 0.5, zt = 50, $t = 250, qt = 10, q = {
  mouse: 0,
  touch: 0,
  pen: 8
}, Jt = f(f({}, v), {}, {
...
class Ft extends et {
  ...
  wheelChange(t) {
    ...
    const i = this.state;
    i._delta = [-tt(t)[1] / Zt * i.offset[0], 0], u.addTo(i._movement, i._delta), nt(i), this.state.origin = [t.clientX, t.clientY], this.compute(t), this.emit();
  }
  wheelEnd() {
...
class re extends S {
  ...
  wheelChange(t) {
    const e = this.state;
    e._delta = tt(t), u.addTo(e._movement, e._delta), nt(e), this.compute(t), this.emit();
  }
  wheelEnd() {
    this.state._active && (this.state._active = !1, this.compute(), this.emit());
  }
    ...
    if (!(e.target && (n = e.target(), !n))) {
      if (e.enabled) {
        for (const o of this.gestures) {
          const c = this.config[o], l = J(i, c.eventOptions, !!n);
          if (c.enabled) {
            const h = B.get(o);
            new h(this, t, o).bind(l);
          }
        }
        const r = J(i, e.eventOptions, !!n);
