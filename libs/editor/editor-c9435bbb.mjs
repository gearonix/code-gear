...
import { useEffect as y, createContext as k, useReducer as P, useMemo as $, useContext as j, useState as B, useCallback as L, lazy as A, Suspense as D } from "react";
import { Link as O } from "react-router-dom";
import { P as I, G as u, i as v, E as T, U as C, u as _, a as E, b as F, p as R, t as x, D as G, c as V, A as W, d as z, e as U, f as q, I as l, g as N, R as Z, h as S, s as n, w as d, j as p, o as J, F as K, k as Q, l as X, m as Y, n as e0, q as t0, r as o0, v as r0, M as s0, N as n0, H as c0, x as a0, T as i0 } from "./index-425b042f.mjs";
import "antd";
...
const z0 = ({ children: e }) => {
  const o = C0();
  return /* @__PURE__ */ t(G, { when: o, children: e });
}, S0 = () => {
  const { Spring: e } = V(), o = e.useSpring({
    from: {
      x: -100
    },
    to: {
  ...
  const e = l0(), o = z(), r = H0(), c = U("isTerminalOpened"), { spring: s, animatedDiv: h } = S0(), a = () => {
  ...
  return /* @__PURE__ */ i(q, { as: h, style: s, children: [
    /* @__PURE__ */ i("div", { children: [
      ...
      /* @__PURE__ */ t(l, { onClick: e, children: /* @__PURE__ */ t(w0, {}) }),
      /* @__PURE__ */ t(l, { onClick: c("terminal"), children: /* @__PURE__ */ t(f0, {}) }),
      /* @__PURE__ */ t(l, { onClick: c("test_cases"), children: /* @__PURE__ */ t(v0, {}) }),
      /* @__PURE__ */ t(l, { onClick: m, children: /* @__PURE__ */ t(N, {}) })
    ] }),
    /* @__PURE__ */ i("div", { children: [
      /* @__PURE__ */ t(l, { onClick: a, children: /* @__PURE__ */ t(b0, {}) }),
      /* @__PURE__ */ t(l, { children: /* @__PURE__ */ t(O, { to: Z.ABOUT, children: /* @__PURE__ */ t(x0, {}) }) })
    ] })
  ] });
}, P0 = () => /* @__PURE__ */ t(W, { children: /* @__PURE__ */ t(k0, {}) }), M = k({}), $0 = ({ children: e }) => {
  const r = S().get("EDITOR_HTML_PREVIEW", {
    html: "<h2>Hi! This is a realtime HTML editor.</h2>",
    css: "h2 {color: #C4CBDA;}",
    javascript: "// 😀"
  }), c = (m, g) => ({ ...m, ...g }), [s, h] = P(c, r), a = $(
    () => ({
      state: s,
      update: h
    }),
...
`, f = J(({ lang: e }) => {
  const { theme: o, fontSize: r, tabSize: c } = E(), s = H();
  return /* @__PURE__ */ i(j0, { children: [
    /* @__PURE__ */ t(B0, { children: e }),
    /* @__PURE__ */ t(
      K,
      {
        theme: o,
...
`, A0 = () => {
  const { state: e } = H(), [o, r] = B(""), c = S(), s = Y(() => {
    r(L0(e)), c.set("EDITOR_HTML_PREVIEW", e);
  }, 250);
  return y(() => {
    s();
...
`, _0 = () => {
  ...
  return /* @__PURE__ */ t(
    t0,
    {
      ...
      onClose: r,
      height: 750,
      children: /* @__PURE__ */ t($0, { children: /* @__PURE__ */ i(D0, { children: [
        /* @__PURE__ */ i(O0, { children: [
          /* @__PURE__ */ t(f, { lang: "html" }),
          /* @__PURE__ */ t(f, { lang: "css" }),
          /* @__PURE__ */ t(f, { lang: "javascript" })
        ] }),
        /* @__PURE__ */ t(I0, { children: /* @__PURE__ */ t(A0, {}) })
      ] }) })
    }
  );
}, F0 = n.div`
...
`, Y0 = n.h1`
  ...
  border-bottom: ${y0} ${p("lightGrey")};
`, R0 = A(() => import("./settings-2d1bd572.mjs")), G0 = n.div`
  ${d("100vw", "100vh")}
`, V0 = n.div`
  ${d("100%", "calc(100% - 45px)")};
  display: flex;
`, w = ({ SignIn: e }) => (h0(), /* @__PURE__ */ t(d0, { children: /* @__PURE__ */ t(r0, { children: /* @__PURE__ */ t(z0, { children: /* @__PURE__ */ t(s0, { SignIn: e, children: /* @__PURE__ */ t(n0, { children: /* @__PURE__ */ i(G0, { children: [
  /* @__PURE__ */ t(c0, {}),
  ...
  /* @__PURE__ */ t(D, { fallback: null, children: /* @__PURE__ */ t(R0, {}) })
