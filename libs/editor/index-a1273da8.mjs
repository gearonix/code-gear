...
var Gh = {};
Object.freeze(Gh);
var RO = typeof Proxy < "u", vO = /* @__PURE__ */ Object.toString();
function Ch() {
  RO || he("Proxy not available");
}
function Uh(e) {
  var t = !1;
  return function() {
...
function fr(e) {
  ...
  return typeof r == "function" && r.toString() === vO;
}
function wh(e) {
  var t = e?.constructor;
...
var z = /* @__PURE__ */ Symbol("mobx administration"), Ro = /* @__PURE__ */ function() {
  function e(r) {
...
}(), sl = /* @__PURE__ */ $r("Atom", Ro);
function Lh(e, t, r) {
  t === void 0 && (t = In), r === void 0 && (r = In);
  var n = new Ro(e);
  return t !== In && MR(n, t), r !== In && _p(n, r), n;
}
function SO(e, t) {
  return e === t;
}
...
var QO = "observable", ZO = "observable.ref", eR = "observable.shallow", tR = "observable.struct", Vh = {
  deep: !0,
  name: void 0,
...
var Wh = /* @__PURE__ */ Ts(QO), rR = /* @__PURE__ */ Ts(ZO, {
  enhancer: ms
}), nR = /* @__PURE__ */ Ts(eR, {
  enhancer: UO
}), iR = /* @__PURE__ */ Ts(tR, {
...
function Ko(e) {
  return e.deep === !0 ? Xn : e.deep === !1 ? ms : aR(e.defaultDecorator);
}
function oR(e) {
  var t;
...
var sR = {
  ...
  array: function(t, r) {
    var n = Yo(r);
    return (U.useProxies === !1 || n.proxy === !1 ? av : JR)(t, Ko(n), n.name);
  },
  map: function(t, r) {
    var n = Yo(r);
    return new Rp(t, Ko(n), n.name);
  },
  set: function(t, r) {
    var n = Yo(r);
  ...
  object: function(t, r, n) {
    return dp(U.useProxies === !1 || n?.proxy === !1 ? So({}, n) : KR({}, n), t, r);
  },
  ref: /* @__PURE__ */ Yt(rR),
  shallow: /* @__PURE__ */ Yt(nR),
  deep: Xh,
  struct: /* @__PURE__ */ Yt(iR)
}, qe = /* @__PURE__ */ Dh(Yh, sR), Kh = "computed", uR = "computed.struct", $h = /* @__PURE__ */ ul(Kh), cR = /* @__PURE__ */ ul(uR, {
...
Object.assign(Es, $h);
Es.struct = /* @__PURE__ */ Yt(cR);
var H_, M_, ka = 0, lR = 1, _R = (H_ = (M_ = /* @__PURE__ */ Ha(function() {
...
function Yn(e, t, r, n) {
  r === void 0 && (r = !1);
  function i() {
    return fR(e, r, t, n || this, arguments);
  }
  return i.isMobxAction = !0, _R && (k_.value = e, Xt(i, "name", k_)), i;
}
...
}(Ro), mR = /* @__PURE__ */ $r("ObservableValue", on), qh;
...
var Xi = /* @__PURE__ */ function() {
  ...
  return t.onBecomeStale_ = function() {
    ...
    this.observers_.size === 0 && !this.keepAlive_)
      ...
      this.keepAlive_ && !n && (U.trackingContext = this), this.trackAndCompute() && RR(this), U.trackingContext = n;
    }
    var i = this.value_;
    if (la(i))
      throw i.cause;
...
function Jh(e, t, r) {
  ...
  return U.inBatch--, U.trackingDerivation = i, TR(e), Ui(n), o;
}
function TR(e) {
  ...
  for (; i--; ) {
    var c = r[i];
    c.diffValue_ === 1 && (c.diffValue_ = 0, OR(c, e));
  }
...
}(), bR = 100, Qu = function(t) {
  return t();
};
function op() {
  U.inBatch > 0 || U.isRunningReactions || Qu(gR);
}
function gR() {
  U.isRunningReactions = !0;
  for (var e = U.pendingReactions, t = 0; e.length > 0; ) {
    ++t === bR && (console.error("[mobx] cycle in reaction: " + e[0]), e.splice(0));
...
var ap = "action", AR = "action.bound", sp = "autoAction", yR = "autoAction.bound", SR = "<unnamed action>", up = /* @__PURE__ */ vo(ap), DR = /* @__PURE__ */ vo(AR, {
  bound: !0
}), cp = /* @__PURE__ */ vo(sp, {
  autoAction: !0
}), GR = /* @__PURE__ */ vo(yR, {
...
function lp(e) {
  var t = function(n, i) {
    if (Mt(n))
      return Yn(n.name || SR, n, e);
    if (Mt(i))
      return Yn(n, i, e);
    if (un(i))
      return Oo(n, i, e ? cp : up);
    if (un(n))
      return Yt(vo(e ? sp : ap, {
        name: n,
        autoAction: e
      }));
  };
...
Object.assign(Ki, cp);
An.bound = /* @__PURE__ */ Yt(DR);
Ki.bound = /* @__PURE__ */ Yt(GR);
function ll(e) {
...
var kR = "never", $o = "always", LR = "observed";
function BR(e) {
  e.isolateGlobalState === !0 && ER();
  var t = e.useProxies, r = e.enforceActions;
  if (t !== void 0 && (U.useProxies = t === $o ? !0 : t === kR ? !1 : typeof Proxy < "u"), t === "ifavailable" && (U.verifyProxies = !0), r !== void 0) {
    var n = r === $o ? $o : r === LR;
  ...
  ["computedRequiresReaction", "reactionRequiresObservable", "observableRequiresReaction", "disableErrorBoundaries", "safeDescriptors"].forEach(function(i) {
    i in e && (U[i] = !!e[i]);
  }), U.allowStateReads = !U.observableRequiresReaction, e.reactionScheduler && IR(e.reactionScheduler);
}
function dp(e, t, r, n) {
...
function hp(e) {
  ...
  return e.observing_ && e.observing_.length > 0 && (t.dependencies = FR(e.observing_).map(hp)), t;
}
function FR(e) {
...
var L_ = /* @__PURE__ */ xh("flow"), VR = /* @__PURE__ */ xh("flow.bound", {
  bound: !0
}), $i = /* @__PURE__ */ Object.assign(function(t, r) {
  if (un(r))
    return Oo(t, r, L_);
  var n = t, i = n.name || "<unnamed flow>", o = function() {
    var s = this, u = arguments, c = ++jR, _ = An(i + " - runid: " + c + " - init", n).apply(s, u), l, f = void 0, h = new Promise(function(d, p) {
      var m = 0;
      l = p;
      function T(v) {
        f = void 0;
        var R;
        try {
          R = An(i + " - runid: " + c + " - yield " + m++, _.next).call(_, v);
        } catch (g) {
          return p(g);
        }
        E(R);
      ...
      function O(v) {
        ...
        var R;
        try {
          R = An(i + " - runid: " + c + " - yield " + m++, _.throw).call(_, v);
        } catch (g) {
          return p(g);
        }
        E(R);
      ...
      function E(v) {
        ...
        return v.done ? d(v.value) : (f = Promise.resolve(v.value), f.then(T, O));
      }
      T(void 0);
    });
...
function Rn(e, t) {
  ...
  if (Jr(e)) {
    ...
    var o = zo(t, e, {});
    return XR(e).forEach(function(a) {
      mo.propertyIsEnumerable.call(e, a) && (o[a] = Rn(e[a], t));
    }), o;
  }
}
function mp(e, t) {
  return Rn(e, /* @__PURE__ */ new Map());
}
function ir(e, t) {
...
function KR(e, t) {
  var r, n;
  return Ch(), e = So(e, t), (n = (r = e[z]).proxy_) != null ? n : r.proxy_ = new Proxy(e, YR);
}
function Rt(e) {
...
var x_ = "splice", Kt = "update", zR = 1e4, qR = {
  get: function(t, r) {
    var n = t[z];
  ...
  function e(r, n, i, o) {
    r === void 0 && (r = "ObservableArray"), this.owned_ = void 0, this.legacyMode_ = void 0, this.atom_ = void 0, this.values_ = [], this.interceptors_ = void 0, this.changeListeners_ = void 0, this.enhancer_ = void 0, this.dehancer = void 0, this.proxy_ = void 0, this.lastKnownLength_ = 0, this.owned_ = i, this.legacyMode_ = o, this.atom_ = new Ro(r), this.enhancer_ = function(a, s) {
  ...
  return t.dehanceValue_ = function(n) {
    ...
    if (n === void 0 ? n = 0 : n > s ? n = s : n < 0 && (n = Math.max(0, s + n)), arguments.length === 1 ? i = s - n : i == null ? i = 0 : i = Math.max(0, Math.min(i, s - n)), o === void 0 && (o = $u), Rt(this)) {
      var u = vt(this, {
        object: this.proxy_,
        type: x_,
        index: n,
...
var QR = /* @__PURE__ */ $r("ObservableArrayAdministration", fl);
function yo(e) {
  return ps(e) && QR(e[z]);
}
var Ep, Op, ZR = {}, Dr = "add", Va = "delete";
Ep = Symbol.iterator;
Op = Symbol.toStringTag;
var Rp = /* @__PURE__ */ function() {
  function e(r, n, i) {
    var o = this;
    n === void 0 && (n = Xn), i === void 0 && (i = "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[z] = ZR, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = n, this.name_ = i, Mt(Map) || he(18), this.keysAtom_ = Lh("ObservableMap.keys()"), this.data_ = /* @__PURE__ */ new Map(), this.hasMap_ = /* @__PURE__ */ new Map(), pR(!0, function() {
      o.merge(r);
    });
  }
  var t = e.prototype;
  return t.has_ = function(n) {
    ...
    var i = this;
    return ir(function() {
      for (var o = ev(n), a = /* @__PURE__ */ new Map(), s = !1, u = Nn(i.data_.keys()), c; !(c = u()).done; ) {
        var _ = c.value;
        if (!o.has(_)) {
          var l = i.delete(_);
          if (l)
      ...
      if (!s)
        if (i.data_.size !== a.size)
          ...
          for (var v = i.data_.keys(), R = a.keys(), g = v.next(), A = R.next(); !g.done; ) {
            if (g.value !== A.value) {
              i.keysAtom_.reportChanged();
              break;
            }
...
}(), Jr = /* @__PURE__ */ $r("ObservableMap", Rp);
function ev(e) {
  if (ii(e) || Jr(e))
    return e;
  if (Array.isArray(e))
...
var gp = /* @__PURE__ */ function() {
  function e(r, n, i) {
    n === void 0 && (n = Xn), i === void 0 && (i = "ObservableSet"), this.name_ = void 0, this[z] = tv, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, Mt(Set) || he(22), this.atom_ = Lh(this.name_), this.enhancer_ = function(o, a) {
      return n(o, a, i);
    }, r && this.replace(r);
  }
  var t = e.prototype;
  ...
  function e(r, n, i, o) {
    n === void 0 && (n = /* @__PURE__ */ new Map()), o === void 0 && (o = zO), this.target_ = void 0, this.values_ = void 0, this.name_ = void 0, this.defaultAnnotation_ = void 0, this.keysAtom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.proxy_ = void 0, this.isPlainObject_ = void 0, this.appliedAnnotations_ = void 0, this.pendingKeys_ = void 0, this.target_ = r, this.values_ = n, this.name_ = i, this.defaultAnnotation_ = o, this.keysAtom_ = new Ro("ObservableObject.keys"), this.isPlainObject_ = fr(this.target_);
  }
  var t = e.prototype;
...
function So(e, t) {
  ...
  if (ur(e, z))
    return e;
  var n = (r = t?.name) != null ? r : "ObservableObject", i = new Ip(e, /* @__PURE__ */ new Map(), String(n), oR(t));
  return To(e, z, i), e;
}
var rv = /* @__PURE__ */ $r("ObservableObjectAdministration", Ip);
function V_(e) {
  return F_[e] || (F_[e] = {
    get: function() {
...
function Kn(e) {
  return ps(e) ? rv(e[z]) : !1;
}
function W_(e, t, r) {
  var n;
  (n = e.target_[Vt]) == null || delete n[r];
}
var nv = /* @__PURE__ */ Ap(0), _u = 0, Np = function() {
};
function iv(e, t) {
  Object.setPrototypeOf ? Object.setPrototypeOf(e.prototype, t) : e.prototype.__proto__ !== void 0 ? e.prototype.__proto__ = t : e.prototype = t;
}
iv(Np, Array.prototype);
var dl = /* @__PURE__ */ function(e, t, r) {
  ...
  function n(o, a, s, u) {
    ...
    return Object.defineProperty(cu(c), "0", nv), c;
  }
  var i = n.prototype;
...
function lv(e) {
  e || (e = cv), BR({ reactionScheduler: e });
}
function _v(e) {
  return xR(e);
}
var fv = 1e4, dv = 1e4, hv = (
  /** @class */
  function() {
    function e(t) {
      var r = this;
      Object.defineProperty(this, "finalize", {
        ...
        writable: !0,
        value: function(n) {
          n === void 0 && (n = fv), clearTimeout(r.sweepTimeout), r.sweepTimeout = void 0;
          var i = Date.now();
    ...
    return Object.defineProperty(e.prototype, "register", {
      ...
      writable: !0,
      value: function() {
        this.sweepTimeout === void 0 && (this.sweepTimeout = setTimeout(this.sweep, dv));
      }
    }), e;
  }()
), pv = typeof FinalizationRegistry < "u" ? FinalizationRegistry : hv, tc = new pv(function(e) {
  var t;
...
function Ev(e, t) {
  t === void 0 && (t = "observed");
  var r = K_(Pe.useState(Tv), 1), n = r[0], i = K_(Pe.useState(), 2), o = i[1], a = function() {
    return o([]);
  }, s = Pe.useRef(null);
  s.current || (s.current = {
    reaction: null,
  ...
  }), tc.register(n, u, u)), Pe.useDebugValue(u.reaction, _v), Pe.useEffect(function() {
...
function Tr(e, t) {
  ...
  return o !== "" && (a.displayName = o), e.contextTypes && (a.contextTypes = e.contextTypes), n && (a = Fn(a)), a = jn(a), Rv(e, a), a;
}
var Ov = {
  $$typeof: !0,
  render: !0,
...
function Rv(e, t) {
  Object.keys(e).forEach(function(r) {
    Ov[r] || Object.defineProperty(t, r, Object.getOwnPropertyDescriptor(e, r));
  });
}
...
}, Qr = () => ot(hi).actions, ai = () => ot(hi), Os = () => ot(hi).getters, Iv = () => ot(hi).services, Nv = () => ot(hi).storage;
function Av(e, t, r) {
...
function Fv(e) {
  e || Mr("initialIsRequired"), Wa(e) || Mr("initialType"), Mv(e) && Mr("initialContent");
}
function jv(e, t) {
...
function Wv(e) {
  ...
  var r = {
    current: e
  }, n = Gi(Kv)(r, t), i = Gi(Yv)(r), o = Gi(qo.changes)(e), a = Gi(Xv)(r);
  function s() {
...
function Qv(e) {
  return e || rf("configIsRequired"), Jv(e) || rf("configType"), e.urls ? (Zv(), {
    paths: {
...
var ib = $v.create({
  ...
  reject: null,
  monaco: null
}), Up = Dv(ib, 2), Do = Up[0], Rs = Up[1];
function ob(e) {
  var t = tb.config(e), r = t.monaco, n = Sv(t, ["monaco"]);
  Rs(function(i) {
    return {
...
function cb(e) {
  ...
  }), r = ub("".concat(t.config.paths.vs, "/loader.js"));
...
var hu = new Promise(function(e, t) {
  ...
  config: ob,
  init: ab,
  __getMonacoInstance: _b
}, fb = { wrapper: { display: "flex", position: "relative", textAlign: "initial" }, fullWidth: { width: "100%" }, hide: { display: "none" } }, pu = fb, db = { container: { display: "flex", height: "100%", width: "100%", justifyContent: "center", alignItems: "center" } }, hb = db;
function pb({ children: e }) {
  return Pe.createElement("div", { style: hb.container }, e);
}
var mb = pb, Tb = mb;
function Eb({ width: e, height: t, isEditorReady: r, loading: n, _ref: i, className: o, wrapperProps: a }) {
  return Pe.createElement("section", { style: { ...pu.wrapper, width: e, height: t }, ...a }, !r && Pe.createElement(Tb, null, n), Pe.createElement("div", { ref: i, style: { ...pu.fullWidth, ...!r && pu.hide }, className: o }));
}
var Ob = Eb, Pp = jn(Ob);
function Rb(e) {
  Le(e, []);
...
function Ib({ original: e, modified: t, language: r, originalLanguage: n, modifiedLanguage: i, originalModelPath: o, modifiedModelPath: a, keepCurrentOriginalModel: s = !1, keepCurrentModifiedModel: u = !1, theme: c = "light", loading: _ = "Loading...", options: l = {}, height: f = "100%", width: h = "100%", className: d, wrapperProps: p = {}, beforeMount: m = Pi, onMount: T = Pi }) {
  let [O, E] = dt(!1), [v, R] = dt(!0), g = ae(null), A = ae(null), G = ae(null), D = ae(T), H = ae(m), Y = ae(!1);
  pl(() => {
    let P = Xa.init();
    return P.then((Q) => (A.current = Q) && R(!1)).catch((Q) => Q?.type !== "cancelation" && console.error("Monaco initialization: error:", Q)), () => g.current ? x() : P.cancel();
  }), ht(() => {
...
var Sb = yb, Jo = /* @__PURE__ */ new Map();
function Db({ defaultValue: e, defaultLanguage: t, defaultPath: r, value: n, language: i, path: o, theme: a = "light", line: s, loading: u = "Loading...", options: c = {}, overrideServices: _ = {}, saveViewState: l = !0, keepCurrentModel: f = !1, width: h = "100%", height: d = "100%", className: p, wrapperProps: m = {}, beforeMount: T = Pi, onMount: O = Pi, onChange: E, onValidate: v = Pi }) {
  let [R, g] = dt(!1), [A, G] = dt(!0), D = ae(null), H = ae(null), Y = ae(null), re = ae(O), Ne = ae(T), x = ae(), P = ae(n), Q = Sb(o), _e = ae(!1), ie = ae(!1);
  pl(() => {
    let Ae = Xa.init();
  ...
  Le(() => {
    R && re.current(H.current, D.current);
  }, [R]), Le(() => {
    !A && !R && se();
  }, [A, R, se]), P.current = n, Le(() => {
    R && E && (x.current?.dispose(), x.current = H.current?.onDidChangeModelContent((Ae) => {
  ...
  return Pe.createElement(Pp, { width: h, height: d, isEditorReady: R, loading: u, _ref: Y, className: p, wrapperProps: m });
}
var Gb = Db, Cb = jn(Gb), Ub = Cb;
const wb = {
...
class ml {
  ...
  get(t, r) {
    ...
    return n ? kb(n) ? JSON.parse(n) : n : r;
  }
  set(t, r) {
    if (!(this.isDisabled || !(t in wb))) {
      if (kp(r))
...
var mu = "Invariant Violation", nf = Object.setPrototypeOf, Lb = nf === void 0 ? function(e, t) {
  ...
  function(e) {
    ...
    function t(r) {
      ...
      return n.framesToPop = 1, n.name = mu, Lb(n, t.prototype), n;
    }
    return t;
  }(Error)
);
...
var Fp = ["debug", "log", "warn", "error", "silent"], Bb = Fp.indexOf("log");
function Qo(e) {
  return function() {
    if (Fp.indexOf(e) >= Bb) {
...
}, Fb = new Set(Object.keys(Vp));
function uf(e) {
  const t = e?.kind;
  return typeof t == "string" && Fb.has(t);
}
var cf;
(function(e) {
...
function Xb(e, t) {
  ...
  if (Yb(e)) {
    const n = e.toJSON();
    if (n !== e)
      return typeof n == "string" ? n : vs(n, r);
...
function Kb(e, t) {
  ...
  return r.length === 0 ? "{}" : t.length > Wp ? "[" + zb(e) + "]" : "{ " + r.map(
    ([i, o]) => i + ": " + vs(o, t)
  ).join(", ") + " }";
}
function $b(e, t) {
  ...
  if (t.length > Wp)
    return "[Array]";
  const r = Math.min(Vb, e.length), n = e.length - r, i = [];
  for (let o = 0; o < r; ++o)
    i.push(vs(e[o], t));
...
function qb(e) {
  return `"${e.replace(Jb, Qb)}"`;
}
const Jb = /[\x00-\x1f\x22\x5c\x7f-\x9f]/g;
function Qb(e) {
...
function hr(e, t, r = Vp) {
  ...
  do {
    ...
    if (!Array.isArray(c)) {
      var d, p;
      uf(c) || xb(!1, `Invalid AST Node: ${Wb(c)}.`);
      const v = T ? (d = n.get(c.kind)) === null || d === void 0 ? void 0 : d.leave : (p = n.get(c.kind)) === null || p === void 0 ? void 0 : p.enter;
      if (E = v?.call(t, c, _, l, f, h), E === Ol)
        break;
      if (E === !1) {
        if (!T) {
          f.pop();
...
`)), `
  ...
  StringValue: {
    leave: ({ value: e, block: t }) => t ? jb(e) : qb(e)
  },
  BooleanValue: {
...
}) !== "ReactNative", Xp = typeof WeakSet == "function", Yp = typeof Symbol == "function" && typeof Symbol.for == "function", bs = Yp && Symbol.asyncIterator;
Gt(function() {
...
var gg = [
  ...
  "export",
  "nonreactive"
], Rl = Object.assign(function(e, t, r) {
...
function Jp(e, t) {
  ...
  var s = Dg(e), u = function(T) {
    ...
    FragmentDefinition: {
      enter: function(T, O, E, v) {
        c.set(JSON.stringify(v), T);
      },
      leave: function(T, O, E, v) {
        var R = c.get(JSON.stringify(v));
        if (T === R)
          return T;
      ...
      leave: function(T) {
        if (T.variableDefinitions) {
          ...
          if (O.size < T.variableDefinitions.length)
            return b(b({}, T), { variableDefinitions: T.variableDefinitions.filter(function(E) {
          ...
          if (i) {
            ...
            if (!o) {
              ...
              if (!(Wr(a) && a.directives && a.directives.some(function(s) {
                ...
                return b(b({}, t), { selections: kr(kr([], i, !0), [hf], !1) });
            }
          }
        }
      }
...
var Ug = function(e, t, r) {
  ...
  return e.prototype.merge = function(t, r) {
    ...
    return Ce(t) && (this.pastCopies.has(t) || (Array.isArray(t) ? t = t.slice(0) : t = b({ __proto__: Object.getPrototypeOf(t) }, t), this.pastCopies.add(t))), t;
  }, e;
}();
function wg(e, t) {
  var r = typeof Symbol < "u" && e[Symbol.iterator] || e["@@iterator"];
...
Fg(vn);
var Of = ye.prototype, Rf = "@@observable";
Of[Rf] || (Of[Rf] = function() {
  return this;
});
...
var bn = function(e) {
  ...
  function t(r) {
    ...
    }), typeof r == "function" && (r = [new ye(r)]), vf(r) ? r.then(function(i) {
      return n.start(i);
...
function Ou(e, t) {
  return Jn(e, t, t.variables && {
    variables: Jn(b(b({}, e && e.variables), t.variables))
  });
}
function $g(e) {
  return !!e.body;
...
function tI(e, t) {
  var r = b({}, e), n = function(o) {
    typeof o == "function" ? r = b(b({}, r), o(r)) : r = b(b({}, r), o);
  }, i = function() {
    return b({}, r);
  };
...
function aI(e) {
  ...
  return bs && (r[Symbol.asyncIterator] = function() {
    return this;
  }), r;
}
function gf(e) {
...
function _I(e, t) {
  ...
  return Ar(this, void 0, void 0, function() {
    var n, i, o, a, s, u, c, _, l, f, h, d, p, m, T, O, E, v, R, g, A, G, D;
...
\r
`), E = fI(T.slice(0, O)), v = E["content-type"], v && v.toLowerCase().indexOf("application/json") === -1)
              throw new Error("Unsupported patch content type: application/json is required.");
            if (R = T.slice(O), R) {
              if (g = om(e, R), Object.keys(g).length > 1 || "data" in g || "incremental" in g || "errors" in g || "payload" in g)
                Kg(g) ? (A = {}, "payload" in g && (A = b({}, g.payload)), "errors" in g && (A = b(b({}, A), { extensions: b(b({}, "extensions" in A ? A.extensions : null), (D = {}, D[Sl] = g.errors, D)) })), t(A)) : t(g);
...
function RI(e, t) {
  ...
  r.forEach(function(l) {
    i = b(b(b({}, i), l.options), { headers: b(b({}, i.headers), l.headers) }), l.credentials && (i.credentials = l.credentials), o = b(b({}, o), l.http);
...
var Nf = Gt(function() {
  ...
  return new si(function(h) {
    ...
    if (Ji(["client"], h.query)) {
      var g = Qp(h.query);
      if (!g)
        return Ru(new Error("HttpLink: Trying to send a client-only query to the server. To send to the server, ensure a non-client field is added to the query or set the `transformOptions.removeClientFields` option to `true`."));
      h.query = g;
    }
    var A = RI(h, o, EI, f, R), G = A.options, D = A.body;
...
), Uf = PI, sm = Uf[vu] || // Earlier versions of this package stored the globalKey property on the Array
// constructor, so we check there as well, to prevent Slot class duplication.
Array[vu] || function(e) {
  try {
    Object.defineProperty(Uf, vu, {
      value: e,
      enumerable: !1,
      writable: !1,
...
function $a(e, { max: t = Math.pow(2, 16), makeCacheKey: r = WI, keyArgs: n, subscribe: i } = /* @__PURE__ */ Object.create(null)) {
  const o = new CI(t, (_) => _.dispose()), a = function() {
    ...
    return o.set(_, l), bu.add(o), ys.hasValue() || (bu.forEach((h) => h.clean()), bu.clear()), f;
  };
  ...
  return e.prototype.batch = function(t) {
    ...
    return this.batch({
      update: function(n) {
        ...
        return o == null ? i : (n.writeQuery(b(b({}, t), { data: o })), o);
      }
    });
    ...
    return this.batch({
      update: function(n) {
        ...
        return o == null ? i : (n.writeFragment(b(b({}, t), { data: o })), o);
      }
    });
  }, e;
}(), Tm = function(e) {
...
function Em(e, t) {
  ...
  if (typeof r == "string" && (t && (t.keyObject = Ri(n) ? Ri(i) ? void 0 : { _id: i } : { id: n }), Ri(n) && !Ri(i) && (n = i), !Ri(n)))
    ...
    if (i) {
      ...
      if (Object.keys(i).forEach(function(c) {
        ...
        if (l !== void 0) {
          ...
          if (f) {
            var h = f === gu ? ma : f(cc(l), b(b({}, u), { fieldName: _, storeFieldName: c, storage: n.getStorage(t, c) }));
...
var Ir = function(e) {
  ...
  return t.prototype.addLayer = function(r, n) {
    ...
    return Ve.call(this.data, r) ? b(b({}, n), e.prototype.findChildRefIds.call(this, r)) : n;
...
function JI(e) {
  return Ce(e) ? He(e) ? e.slice(0) : b({ __proto__: Object.getPrototypeOf(e) }, e) : e;
}
var Tc = function() {
  function e() {
...
var QI = function() {
  function e(t) {
    ...
    this.knownResults = new (Er ? WeakMap : Map)(), this.config = Jn(t, {
      ...
      return s ? o ? b(b({}, s), { result: r.canon.admit(s.result) }) : s : (Mf(n.context.store, n.enclosingRef.__ref), r.execSelectionSetImpl(n));
    }, {
  ...
  return e.prototype.resetCanon = function() {
    ...
    var f = wn(o), h = this.executeSelectionSet({
      ...
      objectOrReference: f,
      enclosingRef: f,
      context: b({ store: r, query: n, policies: l, variables: a, varString: an(a), canonizeResults: _ }, bm(n, this.config.fragments))
    }), d;
    ...
    function d(E, v) {
      var R;
      return E.missing && (f = h.merge(f, (R = {}, R[v] = E.missing, R))), E.result;
    }
    ...
    p.forEach(function(E) {
      ...
      if (Go(E, s))
        if (Wr(E)) {
          ...
          g === void 0 ? bl.added(E) || (f = h.merge(f, (v = {}, v[A] = "Can't find field '".concat(E.name.value, "' on ").concat(ge(i) ? i.__ref + " object" : "object " + JSON.stringify(i, null, 2)), v))) : He(g) ? g = d(r.executeSubSelectedArray({
            field: E,
            array: g,
            enclosingRef: o,
            context: a
            ...
            context: a
          }), A)) : a.canonizeResults && (g = r.canon.pass(g)), g !== void 0 && l.push((R = {}, R[A] = g, R));
        } else {
...
var iN = function() {
  ...
  function e(t) {
    this.config = t, this.typePolicies = /* @__PURE__ */ Object.create(null), this.toBeAdded = /* @__PURE__ */ Object.create(null), this.supertypeMap = /* @__PURE__ */ new Map(), this.fuzzySubtypes = /* @__PURE__ */ new Map(), this.rootIdsByTypename = /* @__PURE__ */ Object.create(null), this.rootTypenamesById = /* @__PURE__ */ Object.create(null), this.usingPossibleTypes = !1, this.config = b({ dataIdFromObject: Em }, t), this.cache = this.config.cache, this.setRootTypename("Query"), this.setRootTypename("Mutation"), this.setRootTypename("Subscription"), t.possibleTypes && this.addPossibleTypes(t.possibleTypes), t.typePolicies && this.addTypePolicies(t.typePolicies);
  }
  return e.prototype.identify = function(t, r) {
    ...
    if (o === this.rootTypenamesById.ROOT_QUERY)
      return ["ROOT_QUERY"];
    for (var a = r && r.storeObject || t, s = b(b({}, r), { typename: o, storeObject: a, readField: r && r.readField || function() {
    ...
    return o === void 0 && (o = t.field ? bg(t.field, t.variables) : Rl(n, Rc(t))), o === !1 ? n : n === Kr(o) ? o : n + ":" + o;
...
function Pl(e, t, r) {
  ...
  return typeof n == "string" ? a = {
    fieldName: n,
    from: o > 1 ? i : t
  } : (a = b({}, n), Ve.call(a, "from") || (a.from = t)), globalThis.__DEV__ !== !1 && a.from === void 0 && globalThis.__DEV__ !== !1 && $.warn(5, jp(Array.from(e))), a.variables === void 0 && (a.variables = r), a;
}
function ym(e) {
  return function(r, n) {
    if (He(r) || He(n))
...
var aN = function() {
  ...
  return e.prototype.writeToStore = function(t, r) {
    ...
    s = b(b({}, vl(c)), s);
    var l = b(b({ store: t, written: /* @__PURE__ */ Object.create(null), merge: function(h, d) {
      return _.merge(h, d);
    }, variables: s, varString: an(s) }, bm(i, this.fragments)), { overwrite: !!u, incomingById: /* @__PURE__ */ new Map(), clientOnly: !1, deferred: !1, flavors: /* @__PURE__ */ new Map() }), f = this.processSelectionSet({
    ...
    return l.incomingById.forEach(function(h, d) {
      ...
      if (globalThis.__DEV__ !== !1 && !l.overwrite) {
        ...
        T.forEach(function(A) {
          A.selectionSet && (v[A.name.value] = !0);
        });
        var R = function(A) {
          return v[Kr(A)] === !0;
        }, g = function(A) {
    ...
    var l = function() {
      ...
      if (ge(E.from)) {
        var v = a.incomingById.get(E.from.__ref);
        if (v) {
          var R = u.readField(b(b({}, E), { from: v.storeObject }), a);
          if (R !== void 0)
            return R;
        }
      }
    ...
    this.flattenFields(o, i, a, _).forEach(function(E, v) {
      var R, g = Vr(v), A = i[g];
      if (f.add(v), A !== void 0) {
        var G = u.getStoreFieldName({
          ...
          field: v,
          variables: E.variables
        }), D = $f(s, G), H = r.processFieldValue(A, v, v.selectionSet ? Nu(E, !1, !1) : E, D), Y = void 0;
        v.selectionSet && (ge(H) || Sn(H)) && (Y = l("__typename", H));
        var re = u.getMergeFunction(_, v.name.value, Y);
        re ? D.info = {
          field: v,
          typename: _,
          merge: re
        } : zf(s, G), c = E.merge(c, (R = {}, R[G] = H, R));
      } else
        globalThis.__DEV__ !== !1 && !E.clientOnly && !E.deferred && !bl.added(v) && !u.getReadFunction(_, v.name.value) && globalThis.__DEV__ !== !1 && $.error(10, Vr(v), i);
    });
    try {
      var h = u.identify(i, {
        typename: _,
    ...
    if (typeof n == "string") {
      ...
      return O ? (O.storeObject = a.merge(O.storeObject, c), O.mergeTree = vc(O.mergeTree, s), f.forEach(function(E) {
    ...
    if (t.map.size && !ge(n)) {
      ...
      }), _ && (n = He(c) ? c.slice(0) : b({}, c), _.forEach(function(f, h) {
        n[h] = f;
      }));
    }
...
function vc(e, t) {
  ...
  if (!e || za(e))
    return t;
  var r = e.info && t.info ? b(b({}, e.info), t.info) : e.info || t.info, n = e.map.size && t.map.size, i = n ? /* @__PURE__ */ new Map() : e.map.size ? e.map : t.map, o = { info: r, map: i };
  if (n) {
    var a = new Set(t.map.keys());
    e.map.forEach(function(s, u) {
      o.map.set(u, vc(s, t.map.get(u))), a.delete(u);
    }), a.forEach(function(s) {
      o.map.set(s, vc(t.map.get(s), e.map.get(s)));
    });
  }
  return o;
}
...
var uN = function(e) {
  ...
  function t(r) {
    ...
    return n.watches = /* @__PURE__ */ new Set(), n.addTypenameTransform = new $p(bl), n.assumeImmutableResults = !0, n.makeVar = rN, n.txCount = 0, n.config = YI(r), n.addTypename = !!n.config.addTypename, n.policies = new oN({
      cache: n,
  ...
  return t.prototype.init = function() {
    ...
    this.storeWriter = new aN(this, this.storeReader = new QI({
      ...
      canonizeResults: Rm(this.config),
    ...
    return u && !this.txCount && this.broadcastWatches(b(b({}, r), { onWatchUpdated: function(f) {
      return l.add(f), !1;
    } })), typeof a == "string" ? this.optimisticData = this.optimisticData.addLayer(a, _) : a === !1 ? _(this.data) : _(), typeof s == "string" && (this.optimisticData = this.optimisticData.removeLayer(s)), u && l.size ? (this.broadcastWatches(b(b({}, r), { onWatchUpdated: function(f, h) {
...
var Qf = Object.assign, _N = Object.hasOwnProperty, bc = function(e) {
  Jt(t, e);
  function t(r) {
    ...
    a.options = b(b({}, o), { initialFetchPolicy: d, fetchPolicy: f }), a.queryId = i.queryId || n.generateQueryId();
    var p = Uo(a.query);
  ...
  return Object.defineProperty(t.prototype, "query", {
    ...
    r === void 0 && (r = !0);
    var n = this.getLastResult(!0), i = this.queryInfo.networkStatus || n && n.networkStatus || be.ready, o = b(b({}, n), { loading: eo(i), networkStatus: i }), a = this.options.fetchPolicy, s = a === void 0 ? "cache-first" : a;
    if (!(Au(s) || this.queryManager.getDocumentInfo(this.query).hasForcedResolvers))
      if (this.waitForOwnResult)
        this.queryInfo.updateWatch();
      else {
        var u = this.queryInfo.getDiff();
        (u.complete || this.options.returnPartialData) && (o.data = u.result), we(o.data, {}) && (o.data = void 0), u.complete ? (delete o.partial, u.complete && o.networkStatus === be.loading && (s === "cache-first" || s === "cache-only") && (o.networkStatus = be.ready, o.loading = !1)) : o.partial = !0, globalThis.__DEV__ !== !1 && !u.complete && !this.options.partialRefetch && !o.loading && !o.data && !o.error && Gm(u.missing);
      }
    ...
    return r && !we(this.options.variables, r) && (i.variables = this.options.variables = b(b({}, this.options.variables), r)), this.queryInfo.resetLastWrite(), this.reobserve(i, be.refetch);
  }, t.prototype.fetchMore = function(r) {
    var n = this, i = b(b({}, r.query ? r : b(b(b(b({}, this.options), { query: this.options.query }), r), { variables: b(b({}, this.options.variables), r.variables) })), { fetchPolicy: "no-cache" });
    ...
    a.networkStatus = be.fetchMore, i.notifyOnNetworkStatusChange && this.observe();
    var u = /* @__PURE__ */ new Set();
    return this.queryManager.fetchQuery(o, i, be.fetchMore).then(function(c) {
      return n.queryManager.removeQuery(o), a.networkStatus === be.fetchMore && (a.networkStatus = s), n.queryManager.cache.batch({
        update: function(_) {
          var l = r.updateQuery;
          l ? _.updateQuery({
            query: n.query,
    ...
    return i && this.last && !we(n, this.last.variables) && (i = void 0), this.last = b({ result: this.queryManager.assumeImmutableResults ? r : rm(r), variables: n }, i ? { error: i } : null);
  }, t.prototype.reobserveAsConcast = function(r, n) {
    var i = this;
    this.isTornDown = !1;
    var o = n === be.refetch || n === be.fetchMore || n === be.poll, a = this.options.variables, s = this.options.fetchPolicy, u = Jn(this.options, r || {}), c = o ? u : Qf(this.options, u), _ = this.transformDocument(c.query);
    this.lastQuery = _, o || (this.updatePolling(), r && r.variables && !we(r.variables, a) && c.fetchPolicy !== "standby" && c.fetchPolicy === s && (this.applyNextFetchPolicy("variables-changed", c), n === void 0 && (n = be.setVariables)));
    var l = _ === c.query ? c : b(b({}, c), { query: _ });
    this.waitForOwnResult && (this.waitForOwnResult = Au(l.fetchPolicy));
    var f = function() {
      i.concast === p && (i.waitForOwnResult = !1);
    }, h = l.variables && b({}, l.variables), d = this.fetch(l, n), p = d.concast, m = d.fromLink, T = {
      next: function(O) {
    ...
    var i = b(b({}, this.getLastResult()), { error: r, errors: r.graphQLErrors, networkStatus: be.error, loading: !1 });
...
var Cm = function() {
  ...
  return e.prototype.addResolvers = function(t) {
    ...
    var r = this.cache;
    return b(b({}, t), { cache: r, getCacheKey: function(n) {
      return r.identify(n);
    } });
    ...
    return r === void 0 && (r = {}), n === void 0 && (n = {}), Ar(this, void 0, void 0, function() {
      return yr(this, function(i) {
        return t ? [2, this.resolveDocument(t, this.buildRootValueFromCache(t, r) || {}, this.prepareContext(n), r).then(function(o) {
          return b(b({}, r), o.exportedVariables);
        })] : [2, b({}, r)];
      });
    });
    ...
    return n === void 0 && (n = {}), i === void 0 && (i = {}), o === void 0 && (o = function() {
      ...
      return yr(this, function(O) {
        return s = wo(t), u = As(t), c = gs(u), _ = this.collectSelectionsToResolve(s, c), l = s.operation, f = l ? l.charAt(0).toUpperCase() + l.slice(1) : "Query", h = this, d = h.cache, p = h.client, m = {
          fragmentMap: c,
          context: b(b({}, n), { cache: d, client: p }),
          variables: i,
          fragmentMatcher: o,
      ...
      return yr(this, function(p) {
        return n ? (o = i.variables, a = t.name.value, s = Vr(t), u = a !== s, c = n[s] || n[a], _ = Promise.resolve(c), (!i.onlyRunForcedResolvers || this.shouldForceResolvers(t)) && (l = n.__typename || i.defaultOperationType, f = this.resolvers && this.resolvers[l], f && (h = f[u ? a : s], h && (_ = Promise.resolve(Cl.withValue(this.cache, h, [
          ...
          if (m === void 0 && (m = c), t.directives && t.directives.forEach(function(v) {
            ...
            return m;
          var E = (O = (T = t.directives) === null || T === void 0 ? void 0 : T.some(function(v) {
...
var Su = function() {
  ...
  return e.prototype.init = function(t) {
    ...
    return this.variables && this.networkStatus !== be.loading && !we(this.variables, t.variables) && (r = be.setVariables), we(t.variables, this.variables) || (this.lastDiff = void 0), Object.assign(this, {
      document: t.document,
      variables: t.variables,
      networkError: null,
    ...
    var n = this.observableQuery;
    if (!(n && n.options.fetchPolicy === "no-cache")) {
      var i = b(b({}, this.getDiffOptions(t)), { watcher: this, callback: function(o) {
        return r.setDiff(o);
      } });
...
var dN = Object.prototype.hasOwnProperty, hN = function() {
  ...
  return e.prototype.stop = function() {
    ...
    return Ar(this, void 0, void 0, function() {
      ...
      return yr(this, function(G) {
        switch (G.label) {
          case 0:
            return $(i, 24), $(p === "network-only" || p === "no-cache", 25), v = this.generateMutationId(), i = this.cache.transformForLink(this.transform(i)), R = this.getDocumentInfo(i).hasClientExports, o = this.getVariables(i, o), R ? [4, this.localState.addExportedVariables(i, o, E)] : [3, 2];
          case 1:
            o = G.sent(), G.label = 2;
          case 2:
            return g = this.mutationStore && (this.mutationStore[v] = {
              ...
              return Eu(A.getObservableFromLink(i, b(b({}, E), { optimisticResponse: a }), o, !1), function(Y) {
                if (pa(Y) && T === "none")
                  throw new mn({
                    graphQLErrors: lc(Y)
                  });
                ...
                error: function(Y) {
                  g && (g.loading = !1, g.error = Y), a && A.cache.removeOptimistic(v), A.broadcastQueries(), H(Y instanceof mn ? Y : new mn({
                    networkError: Y
                  }));
                }
              });
        ...
        updateCache: function(l) {
          ...
          if (f) {
            if (!a) {
              ...
              d.complete && (i = b(b({}, i), { data: d.result }), "incremental" in i && delete i.incremental, "hasNext" in i && delete i.hasNext);
            }
            h && f(l, i, {
              context: t.context,
              variables: t.variables
    ...
    return this.cache.recordOptimisticTransaction(function(o) {
      try {
        n.markMutationResult(b(b({}, r), { result: { data: i } }), o);
      } catch (a) {
    ...
    var n = this;
    return r === void 0 && (r = this.generateQueryId()), $(t.query, 26), $(t.query.kind === "Document", 27), $(!t.returnPartialData, 28), $(!t.pollInterval, 29), this.fetchQuery(r, b(b({}, t), { query: this.transform(t.query) })).finally(function() {
    ...
    if (this.getDocumentInfo(E.query).hasClientExports)
      g = new bn(this.localState.addExportedVariables(E.query, E.variables, E.context).then(v).then(function(D) {
        return D.sources;
      })), A = !0;
    else {
      var G = v(E.variables);
      A = G.fromLink, g = new bn(G.sources);
    }
    return g.promise.then(R, R), {
      concast: g,
      fromLink: A
    };
    ...
    var d = function() {
      ...
      R === void 0 && (R = t.networkStatus || be.loading);
      var g = v.result;
      globalThis.__DEV__ !== !1 && !_ && !we(g, {}) && Gm(v.missing);
      var A = function(G) {
        return ye.of(b({ data: G, loading: eo(R), networkStatus: R }, v.complete ? null : { partial: !0 }));
      };
      ...
      }) : c === "none" && R === be.refetch && Array.isArray(v.missing) ? A(void 0) : A(g);
    }, m = s === "no-cache" ? 0 : n === be.refetch && u !== "merge" ? 1 : 2, T = function() {
    ...
    return b(b({}, r), { clientAwareness: this.clientAwareness });
  }, e;
}(), ed = !1, pN = function() {
  function e(t) {
    var r = this;
  ...
  return Object.defineProperty(e.prototype, "documentTransform", {
    ...
    return this.defaultOptions.watchQuery && (t = Ou(this.defaultOptions.watchQuery, t)), this.disableNetworkFetches && (t.fetchPolicy === "network-only" || t.fetchPolicy === "cache-and-network") && (t = b(b({}, t), { fetchPolicy: "cache-first" })), this.queryManager.watchQuery(t);
  }, e.prototype.query = function(t) {
    return this.defaultOptions.query && (t = Ou(this.defaultOptions.query, t)), $(t.fetchPolicy !== "cache-and-network", 14), this.disableNetworkFetches && t.fetchPolicy === "network-only" && (t = b(b({}, t), { fetchPolicy: "cache-first" })), this.queryManager.query(t);
  }, e.prototype.mutate = function(t) {
...
const { toString: vN } = Object.prototype, { getPrototypeOf: Hl } = Object, Ds = ((e) => (t) => {
  const r = vN.call(t);
...
const QN = (e) => {
  ...
  return r(e, 0);
}, ZN = Qt("AsyncFunction"), e1 = (e) => e && (Cs(e) || gt(e)) && gt(e.then) && gt(e.catch), N = {
  isArray: ui,
  isArrayBuffer: wm,
  isBuffer: bN,
  isFormData: CN,
...
function Us(e, t, r) {
  ...
  function _(d, p, m) {
    ...
    if (d && !m && typeof d == "object") {
      ...
      else if (N.isArray(d) && r1(d) || (N.isFileList(d) || N.endsWith(p, "[]")) && (T = N.toArray(d)))
        return p = jm(p), T.forEach(function(E, v) {
          !(N.isUndefined(E) || E === null) && t.append(
            // eslint-disable-next-line no-nested-ternary
            a === !0 ? nd([p], v, o) : a === null ? p : p + "[]",
            c(E)
          );
        }), !1;
    }
...
function Wm(e, t, r) {
  if (!t)
    return e;
  const n = r && r.encode || i1, i = r && r.serialize;
  let o;
...
}, a1 = typeof URLSearchParams < "u" ? URLSearchParams : Ml, s1 = typeof FormData < "u" ? FormData : null, u1 = typeof Blob < "u" ? Blob : null, c1 = (() => {
  let e;
  return typeof navigator < "u" && ((e = navigator.product) === "ReactNative" || e === "NativeScript" || e === "NS") ? !1 : typeof window < "u" && typeof document < "u";
})(), l1 = (() => typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function")(), Wt = {
  ...
  isStandardBrowserEnv: c1,
  isStandardBrowserWebWorkerEnv: l1,
...
function Ym(e) {
  function t(r, n, i, o) {
    ...
    return a = !a && N.isArray(i) ? i.length : a, u ? (N.hasOwnProp(i, a) ? i[a] = [i[a], n] : i[a] = n, !s) : ((!i[a] || !N.isObject(i[a])) && (i[a] = []), t(r, n, i[a], o) && N.isArray(i[a]) && (i[a] = d1(i[a])), !s);
  }
  ...
  transformRequest: [function(t, r) {
    ...
    if (o) {
      if (n.indexOf("application/x-www-form-urlencoded") > -1)
        return _1(t, this.formSerializer).toString();
    ...
    return o || i ? (r.setContentType("application/json", !1), p1(t)) : t;
  }],
...
N.forEach(["post", "put", "patch"], function(t) {
  ws.headers[t] = N.merge(h1);
});
const kl = ws, m1 = N.toObjectSet([
  "age",
  "authorization",
  "content-length",
  "content-type",
  ...
  return e && e.split(`
`).forEach(function(a) {
    i = a.indexOf(":"), r = a.substring(0, i).trim().toLowerCase(), n = a.substring(i + 1).trim(), !(!r || t[r] && m1[r]) && (r === "set-cookie" ? t[r] ? t[r].push(n) : t[r] = [n] : t[r] = t[r] ? t[r] + ", " + n : n);
  }), t;
}, ad = Symbol("internals");
function vi(e) {
...
class Ps {
  ...
  set(t, r, n) {
    ...
    return N.isPlainObject(t) || t instanceof this.constructor ? a(t, r) : N.isString(t) && (t = t.trim()) && !O1(t) ? a(T1(t), r) : t != null && o(r, t, n), this;
  }
  get(t, r) {
    if (t = vi(t), t) {
...
const g1 = Wt.isStandardBrowserEnv ? (
...
function $m(e, t) {
  return e && !I1(t) ? N1(e, t) : t;
}
const A1 = Wt.isStandardBrowserEnv ? (
...
const D1 = typeof XMLHttpRequest < "u", G1 = D1 && function(e) {
  return new Promise(function(r, n) {
    ...
    if ("onloadend" in c ? c.onloadend = l : c.onreadystatechange = function() {
      ...
      const h = (e.withCredentials || A1(_)) && e.xsrfCookieName && g1.read(e.xsrfCookieName);
...
const C1 = {
  getAdapter: (e) => {
    ...
    const { length: t } = e;
    let r, n;
    for (let i = 0; i < t && (r = e[i], !(n = N.isString(r) ? Ra[r.toLowerCase()] : r)); i++)
      ;
    if (!n)
      throw n === !1 ? new le(
        ...
        N.hasOwnProp(Ra, r) ? `Adapter '${r}' is not available in the build` : `Unknown adapter '${r}'`
      );
    if (!N.isFunction(n))
...
function ud(e) {
  return Uu(e), e.headers = cr.from(e.headers), e.data = Cu.call(
    e,
    e.transformRequest
  ), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), C1.getAdapter(e.adapter || kl.adapter)(e).then(function(n) {
...
const M1 = yc;
function qm(e) {
  const t = new va(e), r = Um(va.prototype.request, t);
  return N.extend(r, va.prototype, t, { allOwnKeys: !0 }), N.extend(r, t, null, { allOwnKeys: !0 }), r.create = function(i) {
    return qm(Zn(e, i));
  }, r;
}
const Fe = qm(kl);
...
Fe.HttpStatusCode = M1;
Fe.default = Fe;
const k1 = Fe, L1 = k1.create({
  baseURL: Lp,
  withCredentials: !0
}), B1 = {
  MAIN: "/",
...
}, Sc = ({ when: e, children: t }) => e ? t : null, Qm = hs({}), j1 = async () => Promise.all([
  Promise.resolve().then(() => $U),
  import("./use-gesture-react.esm-7899cdd1.mjs")
]), xl = ({ children: e }) => {
  const t = ae(), r = ae(), n = x1(), i = async () => {
    const [a, s] = await j1();
...
var Fl, X, Zm, rn, _d, eT, Dc, ba = {}, tT = [], V1 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, Ms = Array.isArray;
function Gr(e, t) {
  for (var r in t)
    e[r] = t[r];
  return e;
...
function Qa() {
  ...
  for (rn.sort(Dc); e = rn.shift(); )
    e.__d && (t = rn.length, n = void 0, i = void 0, o = void 0, s = (a = (r = e).__v).__e, (u = r.__P) && (n = [], i = [], (o = Gr({}, a)).__v = a.__v + 1, sT(u, a, o, r.__n, u.ownerSVGElement !== void 0, a.__h != null ? [s] : null, n, s ?? Ja(a), a.__h, i), Y1(n, a, i), a.__e != s && nT(a)), rn.length > t && rn.sort(Dc));
  Qa.__r = 0;
}
function iT(e, t, r, n, i, o, a, s, u, c, _) {
  var l, f, h, d, p, m, T, O, E, v, R = 0, g = n && n.__k || tT, A = g.length, G = A, D = t.length;
  for (r.__k = [], l = 0; l < D; l++)
    (d = r.__k[l] = (d = t[l]) == null || typeof d == "boolean" || typeof d == "function" ? null : typeof d == "string" || typeof d == "number" || typeof d == "bigint" ? ga(null, d, null, null, d) : Ms(d) ? ga(ro, { children: d }, null, null, null) : d.__b > 0 ? ga(d.type, d.props, d.key, d.ref ? d.ref : null, d.__v) : d) != null && (d.__ = r, d.__b = r.__b + 1, (O = W1(d, g, T = l + R, G)) === -1 ? h = ba : (h = g[O] || ba, g[O] = void 0, G--), sT(e, d, h, i, o, a, s, u, c, _), p = d.__e, (f = d.ref) && h.ref != f && (h.ref && jl(h.ref, null, d), _.push(f, d.__c || p, d)), p != null && (m == null && (m = p), v = !(E = h === ba || h.__v === null) && O === T, E ? O == -1 && R-- : O !== T && (O === T + 1 ? (R++, v = !0) : O > T ? G > D - T ? (R += O - T, v = !0) : R-- : R = O < T && O == T - 1 ? O - T : 0), T = l + R, v = v || O == l && !E, typeof d.type != "function" || O === T && h.__k !== d.__k ? typeof d.type == "function" || v ? d.__d !== void 0 ? (u = d.__d, d.__d = void 0) : u = p.nextSibling : u = aT(e, p, u) : u = oT(d, u, e), typeof r.type == "function" && (r.__d = u)));
  for (r.__e = m, l = A; l--; )
...
function hd(e, t, r) {
  t[0] === "-" ? e.setProperty(t, r ?? "") : e[t] = r == null ? "" : typeof r != "number" || V1.test(t) ? r : r + "px";
}
...
function sT(e, t, r, n, i, o, a, s, u, c) {
  var _, l, f, h, d, p, m, T, O, E, v, R, g, A, G, D = t.type;
  ...
  try {
    e:
      if (typeof D == "function") {
        if (T = t.props, O = (_ = D.contextType) && n[_.__c], E = _ ? O ? O.props.value : _.__ : n, r.__c ? m = (l = t.__c = r.__c).__ = l.__E : ("prototype" in D && D.prototype.render ? t.__c = l = new D(T, E) : (t.__c = l = new lr(T, E), l.constructor = D, l.render = $1), O && O.sub(l), l.props = T, l.state || (l.state = {}), l.context = E, l.__n = n, f = l.__d = !0, l.__h = [], l._sb = []), l.__s == null && (l.__s = l.state), D.getDerivedStateFromProps != null && (l.__s == l.state && (l.__s = Gr({}, l.__s)), Gr(l.__s, D.getDerivedStateFromProps(T, l.__s))), h = l.props, d = l.state, l.__v = t, f)
        ...
        if (l.context = E, l.props = T, l.__P = e, l.__e = !1, R = X.__r, g = 0, "prototype" in D && D.prototype.render) {
          for (l.state = l.__s, l.__d = !1, R && R(t), _ = l.render(l.props, l.state, l.context), A = 0; A < l._sb.length; A++)
            l.__h.push(l._sb[A]);
          l._sb = [];
        } else
          do
        ...
        o == null && t.__v === r.__v ? (t.__k = r.__k, t.__e = r.__e) : t.__e = K1(r.__e, t, r, n, i, o, a, u, c);
    (_ = X.diffed) && _(t);
  } catch (H) {
...
function K1(e, t, r, n, i, o, a, s, u) {
  ...
  if (d === null)
    ...
    if (o = o && Fl.call(e.childNodes), _ = (f = r.props || ba).dangerouslySetInnerHTML, l = h.dangerouslySetInnerHTML, !s) {
      if (o != null)
...
var Gc, ct, wu, Td, Ed = 0, cT = [], Ia = [], Od = X.__b, Rd = X.__r, vd = X.diffed, bd = X.__c, gd = X.unmount;
function z1(e, t) {
...
function vw(e, t) {
  var r = z1(Gc++, 3);
  !X.__s && Q1(r.__H, t) && (r.__ = e, r.i = t, ct.__H.__h.push(r));
}
function q1() {
...
X.__b = function(e) {
  ...
  vd && vd(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (cT.push(t) !== 1 && Td === X.requestAnimationFrame || ((Td = X.requestAnimationFrame) || J1)(q1)), t.__H.__.forEach(function(r) {
...
function tA(e) {
  var t = function(r) {
    var n = e.attr, i = e.size, o = e.title, a = eA(e, ["attr", "size", "title"]), s = i || r.size || "1em", u;
...
function oA(e) {
  function t(w, M, L, W, I) {
    for (var te = 0, C = 0, Te = 0, ue = 0, ve, Z, Xe = 0, at = 0, fe, Je = fe = ve = 0, Ee = 0, Ye = 0, pi = 0, Ke = 0, Xo = L.length, mi = Xo - 1, St, J = "", Me = "", su = "", uu = "", vr; Ee < Xo; ) {
      if (Z = L.charCodeAt(Ee), Ee === mi && C + ue + Te + te !== 0 && (C !== 0 && (Z = C === 47 ? 10 : 47), ue = Te = te = 0, Xo++, mi++), C + ue + Te + te === 0) {
        ...
        switch (Z) {
          case 123:
            for (J = J.trim(), ve = J.charCodeAt(0), fe = 1, Ke = ++Ee; Ee < Xo; ) {
            ...
            switch (fe = L.substring(Ke, Ee), ve === 0 && (ve = (J = J.replace(l, "").trim()).charCodeAt(0)), ve) {
              case 64:
                ...
                if (fe = t(M, Ye, fe, Z, I + 1), Ke = fe.length, 0 < ie && (Ye = r(Q, J, pi), vr = s(3, fe, Ye, M, Ne, re, Ke, Z, I, W), J = Ye.join(""), vr !== void 0 && (Ke = (fe = vr.trim()).length) === 0 && (Z = 0, fe = "")), 0 < Ke)
                  switch (Z) {
                    case 115:
                      J = J.replace(g, a);
                    case 100:
            ...
            su += fe, fe = pi = Ye = Je = ve = 0, J = "", Z = L.charCodeAt(++Ee);
            break;
          case 125:
          case 59:
            if (J = (0 < Ye ? J.replace(f, "") : J).trim(), 1 < (Ke = J.length))
              switch (Je === 0 && (ve = J.charCodeAt(0), ve === 45 || 96 < ve && 123 > ve) && (Ke = (J = J.replace(" ", ":")).length), 0 < ie && (vr = s(1, J, M, w, Ne, re, Me.length, W, I, W)) !== void 0 && (Ke = (J = vr.trim()).length) === 0 && (J = "\0\0"), ve = J.charCodeAt(0), Z = J.charCodeAt(1), ve) {
                case 0:
                  break;
                case 64:
                  if (Z === 105 || Z === 99) {
                ...
                default:
                  J.charCodeAt(Ke - 1) !== 58 && (Me += i(J, ve, Z, J.charCodeAt(2)));
              }
            pi = Ye = Je = ve = 0, J = "", Z = L.charCodeAt(++Ee);
        }
      }
      switch (Z) {
        case 13:
        case 10:
          C === 47 ? C = 0 : 1 + ve === 0 && W !== 107 && 0 < J.length && (Ye = 1, J += "\0"), 0 < ie * Be && s(0, J, M, w, Ne, re, Me.length, W, I, W), re = 1, Ne++;
          break;
        case 59:
        case 125:
          if (C + ue + Te + te === 0) {
    ...
    if (Ke = Me.length, 0 < Ke) {
      if (Ye = M, 0 < ie && (vr = s(2, Me, Ye, w, Ne, re, Ke, W, I, W), vr !== void 0 && (Me = vr).length === 0))
        return uu + Me + su;
  ...
  function s(w, M, L, W, I, te, C, Te, ue, ve) {
    for (var Z = 0, Xe = M, at; Z < ie; ++Z)
      switch (at = _e[Z].call(_, w, Xe, L, W, I, te, C, Te, ue, ve)) {
        case void 0:
        case !1:
        case !0:
        case null:
  ...
  var l = /^\0+/g, f = /[\0\r\f]/g, h = /: */g, d = /zoo|gra/, p = /([,: ])(transform)/g, m = /,\r+?/g, T = /([\t\r\n ])*\f?&/g, O = /@(k\w+)\s*(\S*)\s*/, E = /::(place)/g, v = /:(read-only)/g, R = /[svh]\w+-[tblr]{2}/, g = /\(\s*(.*)\s*\)/g, A = /([\s\S]*?);/g, G = /-self|flex-/g, D = /[^]*?(:[rp][el]a[\w-]+)[^]*/, H = /stretch|:\s*\w+\-(?:conte|avail)/, Y = /([^-])(image-set\()/, re = 1, Ne = 1, x = 0, P = 1, Q = [], _e = [], ie = 0, se = null, Be = 0, Ae = "";
...
function cA() {
  ...
  return Re.AsyncMode = u, Re.ConcurrentMode = c, Re.ContextConsumer = s, Re.ContextProvider = a, Re.Element = t, Re.ForwardRef = _, Re.Fragment = n, Re.Lazy = d, Re.Memo = h, Re.Portal = r, Re.Profiler = o, Re.StrictMode = i, Re.Suspense = l, Re.isAsyncMode = function(R) {
    return v(R) || E(R) === u;
  }, Re.isConcurrentMode = v, Re.isContextConsumer = function(R) {
    return E(R) === s;
  }, Re.isContextProvider = function(R) {
    return E(R) === a;
  }, Re.isElement = function(R) {
    return typeof R == "object" && R !== null && R.$$typeof === t;
  }, Re.isForwardRef = function(R) {
    return E(R) === _;
  }, Re.isFragment = function(R) {
    return E(R) === n;
  }, Re.isLazy = function(R) {
    return E(R) === d;
  }, Re.isMemo = function(R) {
    return E(R) === h;
  }, Re.isPortal = function(R) {
    return E(R) === r;
  }, Re.isProfiler = function(R) {
    return E(R) === o;
  }, Re.isStrictMode = function(R) {
    return E(R) === i;
  }, Re.isSuspense = function(R) {
    return E(R) === l;
  }, Re.isValidElementType = function(R) {
    return typeof R == "string" || typeof R == "function" || R === n || R === c || R === o || R === i || R === l || R === f || typeof R == "object" && R !== null && (R.$$typeof === d || R.$$typeof === h || R.$$typeof === a || R.$$typeof === s || R.$$typeof === _ || R.$$typeof === m || R.$$typeof === T || R.$$typeof === O || R.$$typeof === p);
  }, Re.typeOf = E, Re;
}
pT.exports = cA();
var lA = pT.exports, Wl = lA, _A = {
  childContextTypes: !0,
  contextType: !0,
  contextTypes: !0,
  defaultProps: !0,
...
Xl[Wl.Memo] = mT;
function Gd(e) {
  return Wl.isMemo(e) ? mT : Xl[e.$$typeof] || _A;
}
var hA = Object.defineProperty, pA = Object.getOwnPropertyNames, Cd = Object.getOwnPropertySymbols, mA = Object.getOwnPropertyDescriptor, TA = Object.getPrototypeOf, Ud = Object.prototype;
function TT(e, t, r) {
  if (typeof t != "string") {
    if (Ud) {
      var n = TA(t);
...
}, IA = "style[" + ei + '][data-styled-version="5.3.6"]', NA = new RegExp("^" + ei + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'), AA = function(e, t, r) {
...
`), n = [], i = 0, o = r.length; i < o; i++) {
    ...
    if (a) {
      ...
      if (s) {
        ...
        u !== 0 && (gA(c, u), AA(e, c, s[3]), e.getTag().insertRules(u, n)), n.length = 0;
      } else
        n.push(a);
    }
  }
...
}(), Hd = Kl, UA = { isServer: !Kl, useCSSOMInjection: !RA }, OT = function() {
  function e(r, n, i) {
    r === void 0 && (r = Br), n === void 0 && (n = {}), this.options = or({}, UA, {}, r), this.gs = n, this.names = new Map(i), this.server = !!r.isServer, !this.server && Kl && Hd && (Hd = !1, function(o) {
      for (var a = document.querySelectorAll(IA), s = 0, u = a.length; s < u; s++) {
        var c = a[s];
        c && c.getAttribute(ei) !== "active" && (yA(o, c), c.parentNode && c.parentNode.removeChild(c));
      }
    }(this));
  }
  ...
  return t.reconstructWithOptions = function(r, n) {
    ...
    return this.tag || (this.tag = (i = (n = this.options).isServer, o = n.useCSSOMInjection, a = n.target, r = i ? new CA(a) : o ? new DA(a) : new GA(a), new vA(r)));
    var r, n, i, o, a;
...
function wc(e) {
  ...
  for (t = Math.abs(e); t > 52; t = t / 52 | 0)
    r = Md(t % 52) + r;
  return (Md(t % 52) + r).replace(wA, "$1-$2");
}
var Gn = function(e, t) {
  for (var r = t.length; r; )
...
var HA = RT("5.3.6"), MA = function() {
  function e(t, r, n) {
    this.rules = t, this.staticRulesId = "", this.isStatic = (n === void 0 || n.isStatic) && PA(t), this.componentId = r, this.baseHash = Gn(HA, r), this.baseStyle = n, OT.registerId(r);
  }
...
function BA(e) {
  var t, r, n, i, o = e === void 0 ? Br : e, a = o.options, s = a === void 0 ? Br : a, u = o.plugins, c = u === void 0 ? ts : u, _ = new oA(s), l = [], f = function(p) {
    function m(T) {
      if (T)
        try {
          p(T + "}");
    ...
    return function(T, O, E, v, R, g, A, G, D, H) {
      switch (T) {
        case 1:
    ...
    return m === 0 && LA.indexOf(T[r.length]) !== -1 || T.match(i) ? p : "." + t;
  };
  function d(p, m, T, O) {
    O === void 0 && (O = "&");
    var E = p.replace(kA, ""), v = m && T ? T + " " + m + " { " + E + " }" : E;
    return t = O, r = m, n = new RegExp("\\" + r + "\\b", "g"), i = new RegExp("(\\" + r + "\\b){2,}"), _(T || !m ? "" : m, v);
  }
...
vT.Consumer;
var bT = Pe.createContext(), xA = (bT.Consumer, new OT()), Pc = BA();
function FA() {
  return ot(vT) || xA;
}
function jA() {
...
}(), WA = /([A-Z])/, XA = /([A-Z])/g, YA = /^ms-/, KA = function(e) {
  return "-" + e.toLowerCase();
};
function kd(e) {
  return WA.test(e) ? e.replace(XA, KA).replace(YA, "-ms-") : e;
}
var Ld = function(e) {
  return e == null || e === !1 || e === "";
};
function ti(e, t, r, n) {
  ...
  var c;
  return e instanceof VA ? r ? (e.inject(r, n), e.getName(n)) : e : Uc(e) ? function _(l, f) {
    var h, d, p = [];
    for (var m in l)
      l.hasOwnProperty(m) && !Ld(l[m]) && (Array.isArray(l[m]) && l[m].isCss || no(l[m]) ? p.push(kd(m) + ":", l[m], ";") : Uc(l[m]) ? p.push.apply(p, _(l[m], m)) : p.push(kd(m) + ": " + (h = m, (d = l[m]) == null || typeof d == "boolean" || d === "" ? "" : typeof d != "number" || d === 0 || h in aA ? String(d).trim() : d + "px") + ";"));
...
function Pu(e) {
  return e.replace(zA, "-").replace(qA, "");
}
var JA = function(e) {
  return wc(RT(e) >>> 0);
};
...
function IT(e, t, r) {
  var n = Yl(e), i = !ra(e), o = t.attrs, a = o === void 0 ? ts : o, s = t.componentId, u = s === void 0 ? function(O, E) {
    var v = typeof O != "string" ? "sc" : Pu(O);
    Hu[v] = (Hu[v] || 0) + 1;
    var R = v + "-" + JA("5.3.6" + v + Hu[v]);
    return E ? E + "-" + R : R;
  ...
  n && e.shouldForwardProp && (h = t.shouldForwardProp ? function(O, E, v) {
    return e.shouldForwardProp(O, E, v) && t.shouldForwardProp(O, E, v);
  } : e.shouldForwardProp);
  var d, p = new MA(r, l, n ? e.componentStyle : void 0), m = p.isStatic && a.length === 0, T = function(O, E) {
    return function(v, R, g, A) {
      var G = v.attrs, D = v.componentStyle, H = v.defaultProps, Y = v.foldedComponentIds, re = v.shouldForwardProp, Ne = v.styledComponentId, x = v.target, P = function(W, I, te) {
        W === void 0 && (W = Br);
        var C = or({}, I, { theme: W }), Te = {};
        return te.forEach(function(ue) {
          var ve, Z, Xe, at = ue;
          for (ve in no(at) && (at = at(C)), at)
            C[ve] = Te[ve] = ve === "className" ? (Z = Te[ve], Xe = at[ve], Z && Xe ? Z + " " + Xe : Z || Xe) : at[ve];
        }), [C, Te];
      }($A(R, ot($l), H) || Br, R, G), Q = P[0], _e = P[1], ie = function(W, I, te, C) {
        var Te = FA(), ue = jA(), ve = I ? W.generateAndInjectStyles(Br, Te, ue) : W.generateAndInjectStyles(te, Te, ue);
        return ve;
      }(D, A, Q), se = g, Be = _e.$as || R.$as || _e.as || R.as || x, Ae = ra(Be), w = _e !== R ? or({}, R, {}, _e) : R, M = {};
      for (var L in w)
        L[0] !== "$" && L !== "as" && (L === "forwardedAs" ? M.as = w[L] : (re ? re(L, Sd, Be) : !Ae || Sd(L)) && (M[L] = w[L]));
      return R.style && _e.style !== R.style && (M.style = or({}, R.style, {}, _e.style)), M.className = Array.prototype.concat(Y, Ne, ie !== Ne ? ie : null, R.className, _e.className).filter(Boolean).join(" "), M.ref = se, lO(Be, M);
    }(d, O, E, m);
  };
  return T.displayName = _, (d = Pe.forwardRef(T)).attrs = f, d.componentStyle = p, d.displayName = _, d.shouldForwardProp = h, d.foldedComponentIds = n ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : ts, d.styledComponentId = l, d.target = n ? e.target : e, d.withComponent = function(O) {
    var E = t.componentId, v = function(g, A) {
      if (g == null)
        return {};
      ...
      return H;
    }(t, ["componentId"]), R = E && E + "-" + (ra(O) ? O : Pu(Pd(O)));
    return IT(O, or({}, v, { attrs: f, componentId: R }), r);
  ...
  }, i && OA(d, e, { attrs: !0, componentStyle: !0, displayName: !0, foldedComponentIds: !0, shouldForwardProp: !0, styledComponentId: !0, target: !0, withComponent: !0 }), d;
}
var Mc = function(e) {
...
`, oy = (e, t) => {
  ...
  scroll-behavior: smooth;
  ${zl()};
`, sy = ({ children: e, onClose: t, isOpen: r, height: n }) => {
  const i = oy(t, n);
  return Le(() => {
    i.toggle(r);
  }, [r]), /* @__PURE__ */ K(
...
}, uy = (e) => /* @__PURE__ */ K(xl, { children: /* @__PURE__ */ K(sy, { ...e }) }), AT = ({
  onChange: e,
  value: t,
  options: r,
  defaultValue: n
...
}, _y = (e) => /* @__PURE__ */ K(ly, { children: /* @__PURE__ */ K(cy, { ...e }) }), ql = {
  js: "javascript",
  ts: "typescript",
  tsx: "typescript",
  jsx: "typescript",
  ...
  "go",
  "javascript"
], dy = () => [...new Set(Object.values(ql))].map((t) => ({
  value: t,
  label: t
})), hy = Tr(() => {
  const e = dy(), t = Os(), r = t.getActiveLanguage(), n = t.getActiveTab();
  return /* @__PURE__ */ K(
    AT,
    {
      onChange: (o) => {
...
const Ry = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), xd = {
  randomUUID: Ry
};
function vy(e, t, r) {
...
const by = ({
  ...
  key: vy(),
  wasChanged: !1
}), ST = 9, Dw = [14, 16, 18, 20, 22, 24, 26], Gw = [4, 2], gy = (e) => e.length >= ST;
class Iy {
  constructor(t) {
  ...
  createTab(t) {
    ...
    if (gy(r))
      return null;
    const n = r.at(-1)?.idx, i = by({ fileData: t, lastNumber: n });
...
`, Sy = Tr(() => {
  const { activeKey: e, content: t } = ai(), r = Qr(), n = Ay(t), i = Ny(), o = i.protect(
    (u, c) => {
      if (c === "add")
        r.tabs.createTab();
      else {
...
}, Cy = (e) => Pb(e) ? "name" in e && typeof e.name == "string" && "type" in e && typeof e.type == "string" && "content" in e && typeof e.content == "string" : !1, DT = (e) => {
  const t = e.split(".").at(-1);
  return Uy(t) ? [ql[t], t] : ["text", t];
};
function Uy(e) {
  return e in ql;
}
const GT = {
  ...
  if ("showOpenFilePicker" in window) {
    const [e] = await window.showOpenFilePicker(wy), t = await e.getFile(), r = await t.text(), [n] = DT(t.name);
    return {
      name: t.name,
      type: t.type,
      content: r,
  ...
  try {
    let r = e;
    Hb(e?.createWritable) || (r = await window.showSaveFilePicker());
  ...
  const e = Py(), t = Hy(), r = Qr(), n = Os();
  return {
    openFile: jr(async () => {
      const a = await e();
      Cy(a) && r.tabs.createTab(a);
    }, [r.tabs, e]),
    saveFile: async () => {
...
const My = () => {
  ...
  Gy();
  const i = gv("isTerminalOpened"), o = _n(), a = jr(() => {
...
`, Cw = Tr(() => {
  const e = Qr(), { theme: t, content: r, customBackground: n, customColor: i } = ai(), o = Nv(), a = tw(), s = F1(() => {
  ...
  }, [n, i]), /* @__PURE__ */ mt(ky, { children: [
    /* @__PURE__ */ mt(Ly, { children: [
      /* @__PURE__ */ K(Sy, {}),
      /* @__PURE__ */ mt(By, { children: [
        /* @__PURE__ */ K(my, {}),
        /* @__PURE__ */ K(hy, {})
      ] })
    ] }),
    /* @__PURE__ */ K(xl, { children: /* @__PURE__ */ K(_y, { onChange: c }) })
  ] });
});
function xy(e) {
...
function ee(e) {
  return e._pf == null && (e._pf = jy()), e._pf;
}
var Lc;
...
function Sa(e, t) {
  return e.isValid() ? (t = MT(t, e.localeData()), ku[t] = ku[t] || Ky(t), ku[t](e)) : e.localeData().invalidDate();
}
function MT(e, t) {
  var r = 5;
  function n(i) {
...
function Xs(e) {
  ...
  if (Ge[e] === void 0 && typeof module < "u" && module && module.exports && i0(e))
    try {
      t = ao._abbr, r = xy, r("./locale/" + e), xr(t);
    } catch {
      Ge[e] = null;
    }
  return Ge[e];
...
function u_(e, t) {
  if (t !== null) {
    ...
    return Ge[e] = new e_(Bc(n, t)), bi[e] && bi[e].forEach(function(i) {
      u_(i.name, i.config);
    }), xr(e), Ge[e];
  } else
...
function l_(e) {
  var t, r, n = [], i, o, a;
  if (!e._d) {
    for (i = O0(e), e._w && e._a[jt] == null && e._a[ar] == null && R0(e), e._dayOfYear != null && (a = gn(e._a[Qe], i[Qe]), (e._dayOfYear > xi(a) || e._dayOfYear === 0) && (ee(e)._overflowDayOfYear = !0), r = io(a, 0, e._dayOfYear), e._a[ar] = r.getUTCMonth(), e._a[jt] = r.getUTCDate()), t = 0; t < 3 && e._a[t] == null; ++t)
      e._a[t] = n[t] = i[t];
    for (; t < 7; t++)
...
function __(e) {
  ...
  ee(e).charsLeftOver = s - u, t.length > 0 && ee(e).unusedInput.push(t), e._a[xe] <= 12 && ee(e).bigHour === !0 && e._a[xe] > 0 && (ee(e).bigHour = void 0), ee(e).parsedDateParts = e._a.slice(0), ee(e).meridiem = e._meridiem, e._a[xe] = v0(
    e._locale,
    e._a[xe],
    e._meridiem
...
function rE(e) {
  var t = e._i, r = e._f;
  return e._locale = e._locale || Or(e._l), t === null || r === void 0 && t === "" ? ks({ nullInput: !0 }) : (typeof t == "string" && (e._i = t = e._locale.preparse(t)), Lt(t) ? new Lo(c_(t)) : (ko(t) ? e._d = t : kt(r) ? b0(e) : r ? __(e) : N0(e), Ql(e) || (e._d = null), e));
}
function N0(e) {
  var t = e._i;
...
function hG() {
  ...
  return e >= 0 && t >= 0 && r >= 0 || e <= 0 && t <= 0 && r <= 0 || (e += Xd(Wc(r) + t) * 864e5, t = 0, r = 0), n.milliseconds = e % 1e3, i = Et(e / 1e3), n.seconds = i % 60, o = Et(i / 60), n.minutes = o % 60, a = Et(o / 60), n.hours = a % 24, t += Et(a / 24), u = Et(bE(t)), r += u, t -= Xd(Wc(u)), s = Et(r / 12), r %= 12, n.days = t, n.months = r, n.years = s, this;
}
function bE(e) {
...
function pG(e) {
  ...
  if (e = yt(e), e === "month" || e === "quarter" || e === "year")
    switch (t = this._days + n / 864e5, r = this._months + bE(t), e) {
      case "month":
        return r;
      case "quarter":
        return r / 3;
...
var TG = Rr("ms"), EG = Rr("s"), OG = Rr("m"), RG = Rr("h"), vG = Rr("d"), bG = Rr("w"), gG = Rr("M"), IG = Rr("Q"), NG = Rr("y");
function AG() {
  return xt(this);
}
function yG(e) {
...
`, XG = Fn(
  ...
  Fn((e, t) => {
    const r = ae(null), n = ae(null), { isTerminalOpened: i } = bv(), { executeMessages: o } = ai(), { spring: a, SpringDiv: s } = jG(t), u = () => {
...
`, Uw = Tr(() => {
  ...
  return /* @__PURE__ */ mt(uy, { onClose: a, isOpen: t, height: 300, children: [
    /* @__PURE__ */ K(
      qG,
      {
        items: r.val,
    ...
    /* @__PURE__ */ mt(zG, { children: [
      /* @__PURE__ */ K(nA, { onClick: s }),
      /* @__PURE__ */ K(rA, { onClick: a })
    ] })
  ] });
});
class QG {
  constructor(t) {
    zr(this), this.state = t, this.getters = t.getters, this.tabs = new Iy(t), this.editor = new uv(t), this.terminal = new FG(t);
  }
  changeTheme(t) {
...
const iC = ({
  ...
  /* @__PURE__ */ K(EO, { to: B1.MAIN, children: /* @__PURE__ */ K("img", { src: rC, alt: "" }) }),
...
const lC = () => {
  const { codeRunner: e } = Iv(), t = _n(), r = Z1();
  return async () => {
...
q.cancel = (e) => {
  zs.delete(e), O_.delete(e), R_.delete(e), T_.delete(e), E_.delete(e);
};
q.sync = (e) => {
...
var v_ = typeof window < "u" ? window.requestAnimationFrame : (
...
function IE() {
  wr < 0 && (wr = 0, q.frameLoop !== "demand" && v_(NE));
}
function dC() {
  wr = -1;
}
function NE() {
  ~wr && (v_(NE), q.batchedUpdates(AE));
}
function AE() {
  const e = wr;
  wr = q.now();
  ...
  zs.flush(), T_.flush(e ? Math.min(64, wr - e) : 16.667), O_.flush(), E_.flush(), R_.flush();
}
function jo() {
...
var Ci = (e, ...t) => Fi(e, (r) => r(...t)), b_ = () => typeof window > "u" || !window.navigator || /ServerSideRendering|^Deno\//.test(window.navigator.userAgent), g_, SE, Fr = null, DE = !1, I_ = Yc, GE = (e) => {
...
}, ji = /* @__PURE__ */ new Set(), bt = [], xu = [], cs = 0, Vo = {
  get idle() {
    return !ji.size && !bt.length;
  },
...
function Kc(e) {
  ...
  return cs = 0, xu = bt, xu.length = 0, bt = t, bt.length > 0;
}
function mC(e, t) {
...
var OC = new RegExp("rgb" + qs(wt, wt, wt)), RC = new RegExp("rgba" + qs(wt, wt, wt, wt)), vC = new RegExp("hsl" + qs(wt, ls, ls)), bC = new RegExp(
  "hsla" + qs(wt, ls, ls, wt)
  ...
  return !o && e === s && !t.reset ? u : r.promise = (async () => {
    ...
    const f = new Promise(
      ...
      return (async () => {
        ...
        h(O);
        const v = y.obj(m) ? { ...m } : { ...T, to: m };
        v.parentId = i, qt(c, (g, A) => {
          y.und(v[A]) && (v[A] = g);
        });
...
var Zc = class extends Error {
  ...
  advance(e) {
    ...
    !a && Ot(n.to) && (i = rt(ut(n.to))), n.values.forEach((c, _) => {
      ...
      if (!f) {
        ...
        if (y.und(o.duration))
          if (o.decay) {
            const E = o.decay === !0 ? 0.998 : o.decay, v = Math.exp(-(1 - E) * d);
            h = p + m / (1 - E) * (1 - v), f = Math.abs(c.lastPosition - h) <= O, T = m * v;
          } else {
            T = c.lastVelocity == null ? m : c.lastVelocity;
            const E = o.restVelocity || O / 10, v = o.clamp ? 0 : o.bounce, R = !y.und(v), g = p == l ? c.v0 > 0 : p < l;
            let A, G = !1;
            const D = 1, H = Math.ceil(e / D);
            for (let Y = 0; Y < H && (A = Math.abs(T) > E, !(!A && (f = Math.abs(l - h) <= O, f))); ++Y) {
              R && (G = h == l || h > l == g, G && (T = -T * v, h = l));
  ...
  _merge(e, t, r) {
    ...
    ), v = E ? l : this.get(), R = fo(_), g = y.num(R) || y.arr(R) || Qs(R), A = !d && (!g || Vi(a.immediate || t.immediate, o));
    if (h) {
      const Y = zc(_);
      if (Y !== O.constructor)
        if (A)
    ...
    if (!D) {
      const Y = E || !Wu(this) && f;
      (h || Y) && (H = nr(fo(v), R), D = !H), (!nr(s.immediate, A) && !A || !nr(p.decay, m) || !nr(p.velocity, T)) && (D = !0);
    }
    if (H && gr(this) && (s.changed && !E ? D = !0 : D || this._stop(u)), !d && ((D || Ot(u)) && (s.values = O.getPayload(), s.toValues = Ot(_) ? null : G == _o ? [1] : rt(R)), s.immediate != A && (s.immediate = A, !A && !E && this._set(u)), D)) {
      const { onRest: Y } = s;
    ...
    E && this._set(v), d ? r(zE(t.to, t, this._state, this)) : D ? this._start() : gr(this) && !h ? this._pendingCalls.add(r) : r($E(v));
  }
  ...
  _ ? (t.to = void 0, t.onRest = void 0, c && (c.onRest = void 0)) : V(EU, (p) => {
    ...
    if (y.fun(m)) {
      ...
      t[p] = ({ finished: O, cancelled: E }) => {
        const v = T.get(m);
        v ? (O || (v.finished = !1), E && (v.cancelled = !0)) : T.set(m, {
          value: null,
          finished: O || !1,
          cancelled: E || !1
        });
...
function U_(e, t, r) {
  ...
  const i = Sr(
    ...
    () => ({
      ...
      flush(T, O) {
        const E = il(T, O);
        return o.current > 0 && !s.queue.length && !Object.keys(E).some((R) => !T.springs[R]) ? nl(T, O) : new Promise((R) => {
          ZE(T, E), s.queue.push(() => {
            R(nl(T, O));
          }), a();
        });
  ...
  function l(T, O) {
    for (let E = T; E < O; E++) {
      const v = u.current[E] || (u.current[E] = new C_(null, s.flush)), R = n ? n(E, v) : t[E];
      R && (c[E] = mU(R));
    }
  }
  ...
  ft(() => {
    ...
    T.length && (s.queue = [], V(T, (O) => O())), V(u.current, (O, E) => {
      ...
      const v = c[E];
      v && (S_(O, v.ref), O.ref ? O.queue.push(v) : O.start(v));
    });
  }), Zs(() => () => {
...
function iO(e, t, r) {
  ...
  let v = -a;
  const R = A_(), g = ru(t), A = /* @__PURE__ */ new Map(), G = ae(/* @__PURE__ */ new Map()), D = ae(!1);
  V(d, (x, P) => {
        ...
        if (te.phase == "leave") {
          ...
          if (Te !== !1) {
            ...
            if (te.expired = !0, !C && ue > 0) {
              ue <= 2147483647 && (te.expirationId = setTimeout(R, ue));
              return;
            }
          }
        }
        C && I.some((Te) => Te.expired) && (G.current.delete(te), u && (D.current = !0), R());
      }
    };
    const L = il(x.ctrl, w);
    ...
    const O = /* @__PURE__ */ new WeakMap(), E = () => (s && f.start(s), n(!0), p ? void 0 : () => {
      ...
      g.forEach((A) => {
        ...
        if (A.isIntersecting !== !!G)
          if (A.isIntersecting) {
            const D = E();
            y.fun(D) ? O.set(A.target, D) : R.unobserve(A.target);
          } else
...
(ca.prototype = new lr()).__a = function(e) {
  ...
  return n[0]++, function(i) {
    var o = function() {
      t.props.revealOrder ? (n.push(i), Rh(t, e, n)) : i();
    };
    r ? r(o) : o();
  };
...
X.event = function(e) {
  return vh && (e = vh(e)), e.persist = lw, e.isPropagationStopped = _w, e.isDefaultPrevented = fw, e.nativeEvent = e;
};
...
const kw = dO(() => import("./editor-20e12204.mjs").then((e) => e.e));
export {
  hi as $,
  xl as A,
  Qr as B,
