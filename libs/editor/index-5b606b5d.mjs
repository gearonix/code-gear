...
import Se, { useState as Ze, forwardRef as Zt, memo as er, useContext as Ye, useRef as Z, useCallback as Et, useEffect as Ce, createContext as zi, useMemo as it, createElement as Km, useImperativeHandle as ec, useLayoutEffect as $m, useReducer as zm, lazy as Jm } from "react";
import { jsx as V, jsxs as tn, Fragment as nc } from "react/jsx-runtime";
...
var oc = Object.assign, bi = Object.getOwnPropertyDescriptor, Dn = Object.defineProperty, ho = Object.prototype, ua = [];
Object.freeze(ua);
var ic = {};
Object.freeze(ic);
var rf = typeof Proxy < "u", of = /* @__PURE__ */ Object.toString();
function sc() {
  rf || se("Proxy not available");
}
function ac(e) {
  var n = !1;
  return function() {
...
var af = Object.getOwnPropertyDescriptors || function(n) {
  var t = {};
...
var W = /* @__PURE__ */ Symbol("mobx administration"), To = /* @__PURE__ */ function() {
  ...
  return n.onBO = function() {
    ...
    Je(), Hc(this), v.stateVersion = v.stateVersion < Number.MAX_SAFE_INTEGER ? v.stateVersion + 1 : Number.MIN_SAFE_INTEGER, qe();
  }, n.toString = function() {
    return this.name_;
  }, e;
...
function hc(e, n, t) {
  ...
  var r = new To(e);
  return n !== jt && bp(r, n), t !== jt && Bc(r, t), r;
}
function df(e, n) {
  return e === n;
}
...
}, xe = /* @__PURE__ */ oc(Rc, Xf), gc = "computed", Yf = "computed.struct", Nc = /* @__PURE__ */ eu(gc), Kf = /* @__PURE__ */ eu(Yf, {
  equals: Ri.structural
}), Zi = function(n, t) {
  if (Ct(t))
    return po(n, t, Nc);
  if (zn(n))
...
var __, l_, gi = 0, $f = 1, zf = (__ = (l_ = /* @__PURE__ */ bi(function() {
...
function Qf(e) {
  gi !== e.actionId_ && se(30), gi = e.parentActionId_, e.error_ !== void 0 && (v.suppressReactionErrors = !0), bo(e.prevAllowStateChanges_), wr(e.prevAllowStateReads_), qe(), e.runAsAction_ && dt(e.prevDerivation_), v.suppressReactionErrors = !1;
}
function Zf(e, n) {
  var t = Oo(e);
  try {
...
var vt = /* @__PURE__ */ function(e) {
  ...
  function n(r, o, i, s, a) {
    var u;
    return i === void 0 && (i = "ObservableValue"), a === void 0 && (a = Ri.default), u = e.call(this, i) || this, u.enhancer = void 0, u.name_ = void 0, u.equals = void 0, u.hasUnreportedChange_ = !1, u.interceptors_ = void 0, u.changeListeners_ = void 0, u.value_ = void 0, u.dehancer = void 0, u.enhancer = o, u.name_ = i, u.equals = a, u.value_ = o(r, void 0, i), u;
  }
  var t = n.prototype;
  return t.dehanceValue = function(o) {
    ...
    var i = this.value_;
    this.value_ = o, this.reportChanged(), On(this) && bn(this, {
      type: yn,
      object: this,
      newValue: o,
      oldValue: i
...
var Xr = /* @__PURE__ */ function() {
  ...
  return n.onBecomeStale_ = function() {
    ...
    this.observers_.size === 0 && !this.keepAlive_)
      la(this) && (this.warnAboutUntrackedRead_(), Je(), this.value_ = this.computeValue_(!1), qe());
    ...
    return bo(o), this.isComputing_ = !1, i;
  }, n.suspend_ = function() {
...
}(), Ro = /* @__PURE__ */ Ot("ComputedValue", Xr), ie;
(function(e) {
...
var Yr = /* @__PURE__ */ function() {
  ...
  return n.onBecomeStale_ = function() {
    ...
    if (!this.isDisposed_) {
      ...
      v.trackingContext = r, qe();
    }
  }, n.track = function(r) {
    if (!this.isDisposed_) {
      Je(), this.isRunning_ = !0;
      var o = v.trackingContext;
      v.trackingContext = this;
      var i = Sc(this, r, void 0);
      v.trackingContext = o, this.isRunning_ = !1, this.isTrackPending_ = !1, this.isDisposed_ && ca(this), ei(i) && this.reportExceptionInDerivation_(i.cause), qe();
    }
    ...
    this.isDisposed_ || (this.isDisposed_ = !0, this.isRunning_ || (Je(), ca(this), qe()));
...
function jc(e, n, t, r) {
  var o = typeof r == "function" ? sr(n, t) : sr(n), i = Rn(r) ? r : t, s = e + "L";
...
var d_ = /* @__PURE__ */ fc("flow"), vp = /* @__PURE__ */ fc("flow.bound", {
  ...
  var r = n, o = r.name || "<unnamed flow>", i = function() {
    var a = this, u = arguments, _ = ++Sp, c = Vt(o + " - runid: " + _ + " - init", r).apply(a, u), l, f = void 0, T = new Promise(function(d, h) {
      var m = 0;
      l = h;
      function O(I) {
        f = void 0;
      ...
      function g(I) {
        ...
        return I.done ? d(I.value) : (f = Promise.resolve(I.value), f.then(O, b));
      }
      O(void 0);
    });
...
function Gp(e, n) {
  return e ? n !== void 0 ? ir(e) ? e[W].values_.has(n) : !1 : ir(e) || !!e[W] || Za(e) || Ai(e) || Ro(e) : !1;
}
function ru(e) {
  return Gp(e);
}
...
function Lt(e, n) {
  ...
  if (gt(e)) {
    ...
    return Cp(e).forEach(function(s) {
      ho.propertyIsEnumerable.call(e, s) && (i[s] = Lt(e[s], n));
    }), i;
  }
}
function Xc(e, n) {
...
var m_ = "splice", yn = "update", Hp = 1e4, Pp = {
  ...
  return n.dehanceValue_ = function(r) {
    ...
    this.atom_.reportChanged(), a && bn(this, u);
  ...
  return n.has_ = function(r) {
    ...
    return jn(function() {
      ...
      for (var T = Ft(i.entries()), d; !(d = T()).done; ) {
        var h = d.value, m = h[0], O = h[1], b = o.data_.has(m);
...
var Qc = /* @__PURE__ */ function() {
  function e(t, r, o) {
    r === void 0 && (r = rr), o === void 0 && (o = "ObservableSet"), this.name_ = void 0, this[W] = Lp, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = o, Rn(Set) || se(22), this.atom_ = hc(this.name_), this.enhancer_ = function(i, s) {
      return r(i, s, o);
    }, t && this.replace(t);
  }
  var n = e.prototype;
  ...
  return n.getObservablePropValue_ = function(r) {
    ...
    try {
      ...
      if (!c && (u || _)) {
        var f;
        l = (f = bi(this.target_, r)) == null ? void 0 : f.value;
      }
      if (o) {
...
function ma(e, n, t, r, o) {
  ...
  if (!a) {
    ...
    if (u !== _ && !(Rn(u) && u instanceof u && Rn(_) && _ instanceof _) && "constructor" in e && "constructor" in n)
      return !1;
  }
  if (t === 0)
    return !1;
  ...
  if (r.push(e), o.push(n), a) {
    ...
    if (c = l.length, Object.keys(n).length !== c)
      return !1;
    for (; c--; )
      if (f = l[c], !(Xn(n, f) && ma(e[f], n[f], t - 1, r, o)))
        return !1;
  }
...
class Yp {
  constructor(n) {
    bt(this), this.state = n, this.getters = n.getters;
  }
  saveContent(n, t) {
...
), Zp = typeof FinalizationRegistry < "u" ? FinalizationRegistry : Qp, fa = new Zp(function(e) {
  var n;
...
function tT(e, n) {
  n === void 0 && (n = "observed");
  var t = R_(Se.useState(nT), 1), r = t[0], o = R_(Se.useState(), 2), i = o[1], s = function() {
    return i([]);
  }, a = Se.useRef(null);
  a.current || (a.current = {
    reaction: null,
  ...
  }), fa.register(r, u, u)), Se.useDebugValue(u.reaction, zp), Se.useEffect(function() {
...
}, Nt = () => Ye(Rr).actions, mr = () => Ye(Rr), es = () => Ye(Rr).getters, uT = () => Ye(Rr).services, _T = () => Ye(Rr).storage;
function lT(e, n, t) {
...
function AT(e) {
  e || ht("initialIsRequired"), Ci(e) || ht("initialType"), bT(e) && ht("initialContent");
}
function ST(e, n) {
...
function ZT({ children: e }) {
  return Se.createElement("div", { style: QT.container }, e);
}
var eE = ZT, nE = eE;
function tE({ width: e, height: n, isEditorReady: t, loading: r, _ref: o, className: i, wrapperProps: s }) {
  return Se.createElement("section", { style: { ...Fs.wrapper, width: e, height: n }, ...s }, !t && Se.createElement(nE, null, r), Se.createElement("div", { ref: o, style: { ...Fs.fullWidth, ...!t && Fs.hide }, className: i }));
}
var rE = tE, _d = er(rE);
function oE(e) {
  Ce(e, []);
...
function uE({ original: e, modified: n, language: t, originalLanguage: r, modifiedLanguage: o, originalModelPath: i, modifiedModelPath: s, keepCurrentOriginalModel: a = !1, keepCurrentModifiedModel: u = !1, theme: _ = "light", loading: c = "Loading...", options: l = {}, height: f = "100%", width: T = "100%", className: d, wrapperProps: h = {}, beforeMount: m = kr, onMount: O = kr }) {
  let [b, g] = Ze(!1), [I, p] = Ze(!0), H = Z(null), M = Z(null), K = Z(null), w = Z(O), B = Z(m), Te = Z(!1);
  au(() => {
    let G = Di.init();
  ...
  Ce(() => {
    b && w.current(H.current, M.current);
  }, [b]), Ce(() => {
    !I && !b && Re();
  }, [I, b, Re]), en(() => {
  ...
  return Se.createElement(_d, { width: T, height: f, isEditorReady: b, loading: c, _ref: K, className: d, wrapperProps: h });
}
var _E = uE;
er(_E);
function lE() {
  let [e, n] = Ze(Di.__getMonacoInstance());
  return au(() => {
    let t;
...
function hE({ defaultValue: e, defaultLanguage: n, defaultPath: t, value: r, language: o, path: i, theme: s = "light", line: a, loading: u = "Loading...", options: _ = {}, overrideServices: c = {}, saveViewState: l = !0, keepCurrentModel: f = !1, width: T = "100%", height: d = "100%", className: h, wrapperProps: m = {}, beforeMount: O = kr, onMount: b = kr, onChange: g, onValidate: I = kr }) {
  let [p, H] = Ze(!1), [M, K] = Ze(!0), w = Z(null), B = Z(null), Te = Z(null), fe = Z(b), Re = Z(O), k = Z(), G = Z(r), q = dE(i), _e = Z(!1), ee = Z(!1);
  au(() => {
    let ge = Di.init();
  ...
  return Se.createElement(_d, { width: T, height: d, isEditorReady: p, loading: u, _ref: Te, className: h, wrapperProps: m });
}
...
const bE = rs("string"), ln = rs("function"), md = rs("number"), os = (e) => e !== null && typeof e == "object", RE = (e) => e === !0 || e === !1, ri = (e) => {
  if (ts(e) !== "object")
    return !1;
  const n = uu(e);
...
const $E = (e) => {
  ...
  return t(e, 0);
}, zE = wn("AsyncFunction"), JE = (e) => e && (os(e) || ln(e)) && ln(e.then) && ln(e.catch), R = {
  isArray: fr,
  isArrayBuffer: hd,
  isBuffer: EE,
  isFormData: vE,
...
function QE(e) {
  return R.isArray(e) && !e.some(Ta);
}
const ZE = R.toFlatObject(R, {}, null, function(n) {
...
function is(e, n, t) {
  ...
  const r = t.metaTokens, o = t.visitor || c, i = t.dots, s = t.indexes, u = (t.Blob || typeof Blob < "u" && Blob) && R.isSpecCompliantForm(n);
  if (!R.isFunction(o))
  ...
  function c(d, h, m) {
    ...
    if (d && !m && typeof d == "object") {
      ...
      else if (R.isArray(d) && QE(d) || (R.isFileList(d) || R.endsWith(h, "[]")) && (O = R.toArray(d)))
        return h = gd(h), O.forEach(function(g, I) {
          !(R.isUndefined(g) || g === null) && n.append(
            // eslint-disable-next-line no-nested-ternary
            s === !0 ? H_([h], I, i) : s === null ? h : h + "[]",
            _(g)
          );
        }), !1;
    }
    return Ta(d) ? !0 : (n.append(H_(m, h, i), _(d)), !1);
  }
  ...
  function T(d, h) {
    if (!R.isUndefined(d)) {
      ...
      l.push(d), R.forEach(d, function(O, b) {
        (!(R.isUndefined(O) || O === null) && o.call(
          n,
          O,
          R.isString(b) ? b.trim() : b,
          h,
          f
        )) === !0 && T(O, h ? h.concat(b) : [b]);
      }), l.pop();
    }
  }
  if (!R.isObject(e))
...
function Id(e, n, t) {
  ...
  let i;
  if (o ? i = o(n, t) : i = R.isURLSearchParams(n) ? n.toString() : new _u(n, t).toString(r), i) {
    const s = e.indexOf("#");
...
function aO(e, n) {
  return is(e, new Cn.classes.URLSearchParams(), Object.assign({
    visitor: function(t, r, o, i) {
      return Cn.isNode && R.isBuffer(t) ? (this.append(r, t.toString("base64")), !1) : i.defaultVisitor.apply(this, arguments);
    }
  }, n));
}
function uO(e) {
...
function Sd(e) {
  function n(t, r, o, i) {
    ...
    return s = !s && R.isArray(o) ? o.length : s, u ? (R.hasOwnProp(o, s) ? o[s] = [o[s], r] : o[s] = r, !a) : ((!o[s] || !R.isObject(o[s])) && (o[s] = []), n(t, r, o[s], i) && R.isArray(o[s]) && (o[s] = _O(o[s])), !a);
  }
...
const ss = {
  ...
  transformRequest: [function(n, t) {
    ...
    if (R.isArrayBuffer(n) || R.isBuffer(n) || R.isStream(n) || R.isFile(n) || R.isBlob(n))
      return n;
...
R.forEach(["post", "put", "patch"], function(n) {
  ss.headers[n] = R.merge(lO);
});
const lu = ss, dO = R.toObjectSet([
  "age",
  "authorization",
  "content-length",
  "content-type",
...
function oi(e) {
  return e === !1 || e == null ? e : R.isArray(e) ? e.map(oi) : String(e);
}
function mO(e) {
...
class as {
  ...
  set(n, t, r) {
    ...
    function i(a, u, _) {
      ...
      const l = R.findKey(o, c);
      (!l || o[l] === void 0 || _ === !0 || _ === void 0 && o[l] !== !1) && (o[l || u] = oi(a));
    }
    const s = (a, u) => R.forEach(a, (_, c) => i(_, c, u));
    return R.isPlainObject(n) || n instanceof this.constructor ? s(n, t) : R.isString(n) && (n = n.trim()) && !fO(n) ? s(hO(n), t) : n != null && i(t, n, r), this;
  }
  get(n, t) {
    if (n = Ir(n), n) {
  ...
  function() {
    return {
      write: function(t, r, o, i, s, a) {
        const u = [];
        u.push(t + "=" + encodeURIComponent(r)), R.isNumber(o) && u.push("expires=" + new Date(o).toGMTString()), R.isString(i) && u.push("path=" + i), R.isString(s) && u.push("domain=" + s), a === !0 && u.push("secure"), document.cookie = u.join("; ");
      },
      read: function(t) {
...
const AO = typeof XMLHttpRequest < "u", SO = AO && function(e) {
  return new Promise(function(t, r) {
    ...
    R.isFormData(o) && (Cn.isStandardBrowserEnv || Cn.isStandardBrowserWebWorkerEnv ? i.setContentType(!1) : i.setContentType("multipart/form-data;", !1));
    ...
    o === void 0 && i.setContentType(null), "setRequestHeader" in _ && R.forEach(i.toJSON(), function(d, h) {
      _.setRequestHeader(h, d);
    }), R.isUndefined(e.withCredentials) || (_.withCredentials = !!e.withCredentials), s && s !== "json" && (_.responseType = e.responseType), typeof e.onDownloadProgress == "function" && _.addEventListener("progress", k_(e.onDownloadProgress, !0)), typeof e.onUploadProgress == "function" && _.upload && _.upload.addEventListener("progress", k_(e.onUploadProgress)), (e.cancelToken || e.signal) && (a = (T) => {
...
const vO = {
  getAdapter: (e) => {
    ...
    const { length: n } = e;
    let t, r;
    for (let o = 0; o < n && (t = e[o], !(r = R.isString(t) ? ii[t.toLowerCase()] : t)); o++)
      ;
    if (!r)
      throw r === !1 ? new re(
        ...
        R.hasOwnProp(ii, t) ? `Adapter '${t}' is not available in the build` : `Unknown adapter '${t}'`
      );
    if (!R.isFunction(r))
...
function ar(e, n) {
  ...
  const t = {};
  function r(_, c, l) {
    return R.isPlainObject(_) && R.isPlainObject(c) ? R.merge.call({ caseless: l }, _, c) : R.isPlainObject(c) ? R.merge({}, c) : R.isArray(c) ? c.slice() : c;
  }
  function o(_, c, l) {
    if (R.isUndefined(c)) {
      if (!R.isUndefined(_))
  ...
  return R.forEach(Object.keys(Object.assign({}, e, n)), function(c) {
    const l = u[c] || o, f = l(e[c], n[c], c);
    R.isUndefined(f) && l !== a || (t[c] = f);
  }), t;
}
const Cd = "1.4.0", cu = {};
...
function Dd(e) {
  ...
  return R.extend(t, si.prototype, n, { allOwnKeys: !0 }), R.extend(t, n, null, { allOwnKeys: !0 }), t.create = function(o) {
    return Dd(ar(e, o));
  }, t;
}
const Ue = Dd(lu);
...
const HO = Ue, PO = { GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_876f0290-373d-4e3b-b38a-1b61ce67029c", STATS_TRP: "true", DEPLOYMENT_BASEPATH: "/opt/runner", DOTNET_NOLOGO: "1", USER: "runner", npm_config_user_agent: "npm/8.19.4 node/v16.20.1 linux x64 workspaces/false ci/github-actions", CI: "true", RUNNER_ENVIRONMENT: "github-hosted", GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_876f0290-373d-4e3b-b38a-1b61ce67029c", PIPX_HOME: "/opt/pipx", npm_node_execpath: "/opt/hostedtoolcache/node/16.20.1/x64/bin/node", JAVA_HOME_8_X64: "/usr/lib/jvm/temurin-8-jdk-amd64", SHLVL: "1", npm_config_noproxy: "", HOME: "/home/runner", RUNNER_TEMP: "/home/runner/work/_temp", GITHUB_EVENT_PATH: "/home/runner/work/_temp/_github_workflow/event.json", npm_package_json: "/home/runner/work/CodeGear/CodeGear/package.json", JAVA_HOME_11_X64: "/usr/lib/jvm/temurin-11-jdk-amd64", PIPX_BIN_DIR: "/opt/pipx_bin", GITHUB_REPOSITORY_OWNER: "Gearonix", npm_config_auto_install_peers: "true", GRADLE_HOME: "/usr/share/gradle-8.2.1", ANDROID_NDK_LATEST_HOME: "/usr/local/lib/android/sdk/ndk/25.2.9519653", STATS_RDCL: "true", GITHUB_RETENTION_DAYS: "90", GITHUB_REPOSITORY_OWNER_ID: "74734213", POWERSHELL_DISTRIBUTION_CHANNEL: "GitHub-Actions-ubuntu22", AZURE_EXTENSION_DIR: "/opt/az/azcliextensions", GITHUB_HEAD_REF: "", npm_config_userconfig: "/home/runner/.npmrc", npm_config_local_prefix: "/home/runner/work/CodeGear/CodeGear", SYSTEMD_EXEC_PID: "662", GITHUB_GRAPHQL_URL: "https://api.github.com/graphql", COLOR: "0", GOROOT_1_20_X64: "/opt/hostedtoolcache/go/1.20.6/x64", NVM_DIR: "/home/runner/.nvm", npm_config_metrics_registry: "https://registry.npmjs.org/", DOTNET_SKIP_FIRST_TIME_EXPERIENCE: "1", JAVA_HOME_17_X64: "/usr/lib/jvm/temurin-17-jdk-amd64", ImageVersion: "20230724.1.0", RUNNER_OS: "Linux", GITHUB_API_URL: "https://api.github.com", SWIFT_PATH: "/usr/share/swift/usr/bin", RUNNER_USER: "runner", STATS_V3PS: "true", CHROMEWEBDRIVER: "/usr/local/share/chromedriver-linux64", JOURNAL_STREAM: "8:16737", GITHUB_WORKFLOW: "CodeGear CI", _: "/opt/hostedtoolcache/node/16.20.1/x64/bin/npm", npm_config_prefix: "/opt/hostedtoolcache/node/16.20.1/x64", GITHUB_RUN_ID: "5683419378", npm_config_cache: "/home/runner/.npm", GITHUB_REF_TYPE: "branch", BOOTSTRAP_HASKELL_NONINTERACTIVE: "1", GITHUB_WORKFLOW_SHA: "6bbccb21f8afefe4083e0f412c99d1708d6b54dd", GITHUB_BASE_REF: "", ImageOS: "ubuntu22", GITHUB_WORKFLOW_REF: "Gearonix/CodeGear/.github/workflows/master.yml@refs/heads/develop", PERFLOG_LOCATION_SETTING: "RUNNER_PERFLOG", GOROOT_1_18_X64: "/opt/hostedtoolcache/go/1.18.10/x64", GITHUB_ACTION_REPOSITORY: "", npm_config_node_gyp: "/opt/hostedtoolcache/node/16.20.1/x64/lib/node_modules/npm/node_modules/node-gyp/bin/node-gyp.js", PATH: "/home/runner/work/CodeGear/CodeGear/node_modules/.bin:/home/runner/work/CodeGear/node_modules/.bin:/home/runner/work/node_modules/.bin:/home/runner/node_modules/.bin:/home/node_modules/.bin:/node_modules/.bin:/opt/hostedtoolcache/node/16.20.1/x64/lib/node_modules/npm/node_modules/@npmcli/run-script/lib/node-gyp-bin:/home/runner/setup-pnpm/node_modules/.bin:/opt/hostedtoolcache/node/16.20.1/x64/bin:/home/runner/.local/bin:/opt/pipx_bin:/home/runner/.cargo/bin:/home/runner/.config/composer/vendor/bin:/usr/local/.ghcup/bin:/home/runner/.dotnet/tools:/snap/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin", ANT_HOME: "/usr/share/ant", DOTNET_MULTILEVEL_LOOKUP: "0", RUNNER_TRACKING_ID: "github_ceda020e-4e87-4ef5-aa83-e88593341f53", INVOCATION_ID: "10c62eba8c294053bca644783689350b", RUNNER_TOOL_CACHE: "/opt/hostedtoolcache", GOROOT_1_19_X64: "/opt/hostedtoolcache/go/1.19.11/x64", NODE: "/opt/hostedtoolcache/node/16.20.1/x64/bin/node", npm_package_name: "@code-gear/source", GITHUB_ACTION: "__run_2", GITHUB_RUN_NUMBER: "31", GITHUB_TRIGGERING_ACTOR: "Gearonix", RUNNER_ARCH: "X64", XDG_RUNTIME_DIR: "/run/user/1001", AGENT_TOOLSDIRECTORY: "/opt/hostedtoolcache", LANG: "C.UTF-8", VCPKG_INSTALLATION_ROOT: "/usr/local/share/vcpkg", CONDA: "/usr/share/miniconda", RUNNER_NAME: "GitHub Actions 3", XDG_CONFIG_HOME: "/home/runner/.config", STATS_VMD: "true", GITHUB_REF_NAME: "develop", GITHUB_REPOSITORY: "Gearonix/CodeGear", npm_lifecycle_script: " nx run-many --targets=build --all", ANDROID_NDK_ROOT: "/usr/local/lib/android/sdk/ndk/25.2.9519653", GITHUB_ACTION_REF: "", DEBIAN_FRONTEND: "noninteractive", GITHUB_REPOSITORY_ID: "659143083", GITHUB_ACTIONS: "true", STATS_NM: "true", npm_package_version: "0.0.0", npm_lifecycle_event: "build", NODE_PATH: "/home/runner/work/CodeGear/CodeGear/node_modules/.pnpm/nx@16.4.0/node_modules/nx/bin/node_modules:/home/runner/work/CodeGear/CodeGear/node_modules/.pnpm/nx@16.4.0/node_modules/nx/node_modules:/home/runner/work/CodeGear/CodeGear/node_modules/.pnpm/nx@16.4.0/node_modules:/home/runner/work/CodeGear/CodeGear/node_modules/.pnpm/node_modules", GITHUB_REF_PROTECTED: "false", npm_config_strict_peer_dependencies: "", GITHUB_WORKSPACE: "/home/runner/work/CodeGear/CodeGear", ACCEPT_EULA: "Y", GITHUB_JOB: "building", RUNNER_PERFLOG: "/home/runner/perflog", GITHUB_SHA: "6bbccb21f8afefe4083e0f412c99d1708d6b54dd", GITHUB_RUN_ATTEMPT: "1", GITHUB_REF: "refs/heads/develop", GITHUB_ACTOR: "Gearonix", ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk", LEIN_HOME: "/usr/local/lib/lein", npm_config_globalconfig: "/opt/hostedtoolcache/node/16.20.1/x64/etc/npmrc", npm_config_init_module: "/home/runner/.npm-init.js", GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_876f0290-373d-4e3b-b38a-1b61ce67029c", JAVA_HOME: "/usr/lib/jvm/temurin-11-jdk-amd64", PWD: "/home/runner/work/CodeGear/CodeGear", GITHUB_ACTOR_ID: "74734213", RUNNER_WORKSPACE: "/home/runner/work/CodeGear", npm_execpath: "/opt/hostedtoolcache/node/16.20.1/x64/lib/node_modules/npm/bin/npm-cli.js", HOMEBREW_CLEANUP_PERIODIC_FULL_DAYS: "3650", STATS_TIS: "mining", GITHUB_EVENT_NAME: "push", HOMEBREW_NO_AUTO_UPDATE: "1", ANDROID_HOME: "/usr/local/lib/android/sdk", GITHUB_SERVER_URL: "https://github.com", GECKOWEBDRIVER: "/usr/local/share/gecko_driver", LEIN_JAR: "/usr/local/lib/lein/self-installs/leiningen-2.10.0-standalone.jar", GHCUP_INSTALL_BASE_PREFIX: "/usr/local", GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_876f0290-373d-4e3b-b38a-1b61ce67029c", npm_config_global_prefix: "/opt/hostedtoolcache/node/16.20.1/x64", EDGEWEBDRIVER: "/usr/local/share/edge_driver", STATS_EXT: "true", npm_command: "run-script", ANDROID_NDK: "/usr/local/lib/android/sdk/ndk/25.2.9519653", SGX_AESM_ADDR: "1", CHROME_BIN: "/usr/bin/google-chrome", SELENIUM_JAR_PATH: "/usr/share/java/selenium-server.jar", PNPM_HOME: "/home/runner/setup-pnpm/node_modules/.bin", STATS_EXTP: "https://provjobdsettingscdn.blob.core.windows.net/settings/provjobdsettings-0.5.154/provjobd.data", ANDROID_NDK_HOME: "/usr/local/lib/android/sdk/ndk/25.2.9519653", GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_876f0290-373d-4e3b-b38a-1b61ce67029c", INIT_CWD: "/home/runner/work/CodeGear/CodeGear", EDITOR: "vi", NX_CLI_SET: "true", NX_LOAD_DOT_ENV_FILES: "true", NX_INVOKED_BY_RUNNER: "true", NX_WORKSPACE_ROOT: "/home/runner/work/CodeGear/CodeGear", NX_TERMINAL_OUTPUT_PATH: "/home/runner/work/CodeGear/CodeGear/node_modules/.cache/nx/terminalOutputs/16795053167322030392", NX_TASK_TARGET_PROJECT: "editor", NX_TASK_TARGET_TARGET: "build", NX_TASK_TARGET_CONFIGURATION: "production", NX_TASK_HASH: "16795053167322030392", LERNA_PACKAGE_NAME: "editor", NODE_ENV: "production" }.SERVER_URL ?? "http://localhost:6868", wO = {
...
}, ba = ({ when: e, children: n }) => e ? n : null, yd = zi({}), jO = async () => Promise.all([
  ...
  return /* @__PURE__ */ V(yd.Provider, { value: i, children: /* @__PURE__ */ V(ba, { when: r.val, children: e }) });
}, us = () => Ye(yd);
var mu, F, Hd, At, j_, Pd, Ra, ai = {}, wd = [], FO = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, _s = Array.isArray;
function at(e, n) {
  for (var t in n)
    e[t] = n[t];
  return e;
...
function Hi() {
  ...
  for (At.sort(Ra); e = At.shift(); )
    e.__d && (n = At.length, r = void 0, o = void 0, i = void 0, a = (s = (t = e).__v).__e, (u = t.__P) && (r = [], o = [], (i = at({}, s)).__v = s.__v + 1, jd(u, s, i, t.__n, u.ownerSVGElement !== void 0, s.__h != null ? [a] : null, r, a ?? yi(s), s.__h, o), XO(r, s, o), s.__e != a && kd(s)), At.length > n && At.sort(Ra));
  Hi.__r = 0;
}
function xd(e, n, t, r, o, i, s, a, u, _, c) {
  var l, f, T, d, h, m, O, b, g, I, p = 0, H = r && r.__k || wd, M = H.length, K = M, w = n.length;
  for (t.__k = [], l = 0; l < w; l++)
    (d = t.__k[l] = (d = n[l]) == null || typeof d == "boolean" || typeof d == "function" ? null : typeof d == "string" || typeof d == "number" || typeof d == "bigint" ? ui(null, d, null, null, d) : _s(d) ? ui(Qr, { children: d }, null, null, null) : d.__b > 0 ? ui(d.type, d.props, d.key, d.ref ? d.ref : null, d.__v) : d) != null && (d.__ = t, d.__b = t.__b + 1, (b = VO(d, H, O = l + p, K)) === -1 ? T = ai : (T = H[b] || ai, H[b] = void 0, K--), jd(e, d, T, o, i, s, a, u, _, c), h = d.__e, (f = d.ref) && T.ref != f && (T.ref && fu(T.ref, null, d), c.push(f, d.__c || h, d)), h != null && (m == null && (m = h), I = !(g = T === ai || T.__v === null) && b === O, g ? b == -1 && p-- : b !== O && (b === O + 1 ? (p++, I = !0) : b > O ? K > w - O ? (p += b - O, I = !0) : p-- : p = b < O && b == O - 1 ? b - O : 0), O = l + p, I = I || b == l && !g, typeof d.type != "function" || b === O && T.__k !== d.__k ? typeof d.type == "function" || I ? d.__d !== void 0 ? (u = d.__d, d.__d = void 0) : u = h.nextSibling : u = Bd(e, h, u) : u = Ld(d, u, e), typeof t.type == "function" && (t.__d = u)));
  for (t.__e = m, l = M; l--; )
...
function jd(e, n, t, r, o, i, s, a, u, _) {
  var c, l, f, T, d, h, m, O, b, g, I, p, H, M, K, w = n.type;
  ...
  try {
    e:
      if (typeof w == "function") {
        if (O = n.props, b = (c = w.contextType) && r[c.__c], g = c ? b ? b.props.value : c.__ : r, t.__c ? m = (l = n.__c = t.__c).__ = l.__E : ("prototype" in w && w.prototype.render ? n.__c = l = new w(O, g) : (n.__c = l = new Kn(O, g), l.constructor = w, l.render = KO), b && b.sub(l), l.props = O, l.state || (l.state = {}), l.context = g, l.__n = r, f = l.__d = !0, l.__h = [], l._sb = []), l.__s == null && (l.__s = l.state), w.getDerivedStateFromProps != null && (l.__s == l.state && (l.__s = at({}, l.__s)), at(l.__s, w.getDerivedStateFromProps(O, l.__s))), T = l.props, d = l.state, l.__v = n, f)
        ...
        if (l.context = g, l.props = O, l.__P = e, l.__e = !1, p = F.__r, H = 0, "prototype" in w && w.prototype.render) {
          ...
          while (l.__d && ++H < 25);
        l.state = l.__s, l.getChildContext != null && (r = at(at({}, r), l.getChildContext())), f || l.getSnapshotBeforeUpdate == null || (h = l.getSnapshotBeforeUpdate(T, d)), xd(e, _s(K = c != null && c.type === Qr && c.key == null ? c.props.children : c) ? K : [K], n, t, r, o, i, s, a, u, _), l.base = n.__e, n.__h = null, l.__h.length && s.push(l), m && (l.__E = l.__ = null);
      } else
...
function YO(e, n, t, r, o, i, s, a, u) {
  ...
  if (d === null)
    ...
    if (i = i && mu.call(e.childNodes), c = (f = t.props || ai).dangerouslySetInnerHTML, l = T.dangerouslySetInnerHTML, !a) {
      if (i != null)
    ...
    if (WO(e, T, f, o, a), l)
      n.__k = [];
    else if (xd(e, _s(h = n.props.children) ? h : [h], n, t, r, o && d !== "foreignObject", i, s, i ? i[0] : t.__k && yi(t, 0), a, u), i != null)
      for (h = i.length; h--; )
        i[h] != null && Md(i[h]);
...
}, Kn.prototype.render = Qr, At = [], Pd = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Ra = function(e, n) {
...
const Xd = zi(
  ...
  return /* @__PURE__ */ tn(nc, { children: [
    t,
    /* @__PURE__ */ V(Xd.Provider, { value: { open: r }, children: e })
  ] });
}, ZO = () => Ye(Xd), eb = (e) => typeof e == "object" && e !== null, Yd = (e) => typeof e == "string", nb = (e) => typeof e == "function";
class Kd {
  constructor(n) {
  ...
  get(n, t) {
    ...
    return r ? tb(r) ? JSON.parse(r) : r : t;
  }
  set(n, t) {
...
var $d = {
  ...
  style: void 0,
  attr: void 0
}, el = Se.createContext && Se.createContext($d), mt = globalThis && globalThis.__assign || function() {
...
}, rb = globalThis && globalThis.__rest || function(e, n) {
  var t = {};
  for (var r in e)
...
function zd(e) {
  return e && e.map(function(n, t) {
    return Se.createElement(n.tag, mt({
      key: t
    }, n.attr), zd(n.child));
  });
}
...
function ob(e) {
  var n = function(t) {
    var r = e.attr, o = e.size, i = e.title, s = rb(e, ["attr", "size", "title"]), a = o || t.size || "1em", u;
    return t.className && (u = t.className), e.className && (u = (u ? u + " " : "") + e.className), Se.createElement("svg", mt({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, r, s, {
  ...
  return el !== void 0 ? Se.createElement(el.Consumer, null, function(t) {
    return n(t);
  }) : n($d);
}
function ib(e) {
...
function ub() {
  ...
  return de.ContextConsumer = s, de.ContextProvider = i, de.Element = e, de.ForwardRef = u, de.Fragment = t, de.Lazy = f, de.Memo = l, de.Portal = n, de.Profiler = o, de.StrictMode = r, de.Suspense = _, de.SuspenseList = c, de.isAsyncMode = function() {
    return !1;
...
function _b(e) {
  function n(C, U, P, j, E) {
    for (var J = 0, S = 0, le = 0, ne = 0, me, $, Pe = 0, Ke = 0, oe, Le = oe = me = 0, ce = 0, we = 0, gr = 0, Me = 0, xo = P.length, Nr = xo - 1, fn, Y = "", ve = "", Ps = "", ws = "", nt; ce < xo; ) {
          ...
          case 123:
            ...
            switch (oe = P.substring(Me, ce), me === 0 && (me = (Y = Y.replace(l, "").trim()).charCodeAt(0)), me) {
              case 64:
                ...
                if (oe = n(U, we, oe, $, E + 1), Me = oe.length, 0 < ee && (we = t(q, Y, gr), nt = a(3, oe, we, U, Re, fe, Me, $, E, j), Y = we.join(""), nt !== void 0 && (Me = (oe = nt.trim()).length) === 0 && ($ = 0, oe = "")), 0 < Me)
                  switch ($) {
                    case 115:
                      Y = Y.replace(H, s);
                    case 100:
                    ...
                    case 45:
                      ...
                      break;
                    case 107:
                      Y = Y.replace(b, "$1 $2"), oe = Y + "{" + oe + "}", oe = G === 1 || G === 2 && i("@" + oe, 3) ? "@-webkit-" + oe + "@" + oe : "@" + oe;
                      break;
                    default:
                      oe = Y + oe, j === 112 && (oe = (ve += oe, ""));
                  }
                else
                  oe = "";
                break;
            ...
            Ps += oe, oe = gr = we = Le = me = 0, Y = "", $ = P.charCodeAt(++ce);
            break;
          case 125:
          case 59:
            if (Y = (0 < we ? Y.replace(f, "") : Y).trim(), 1 < (Me = Y.length))
              switch (Le === 0 && (me = Y.charCodeAt(0), me === 45 || 96 < me && 123 > me) && (Me = (Y = Y.replace(" ", ":")).length), 0 < ee && (nt = a(1, Y, U, C, Re, fe, ve.length, j, E, j)) !== void 0 && (Me = (Y = nt.trim()).length) === 0 && (Y = "\0\0"), me = Y.charCodeAt(0), $ = Y.charCodeAt(1), me) {
                case 0:
                  break;
                case 64:
                  if ($ === 105 || $ === 99) {
                ...
                default:
                  Y.charCodeAt(Me - 1) !== 58 && (ve += o(Y, me, $, Y.charCodeAt(2)));
              }
      ...
      switch ($) {
        case 13:
        case 10:
          S === 47 ? S = 0 : 1 + me === 0 && j !== 107 && 0 < Y.length && (we = 1, Y += "\0"), 0 < ee * He && a(0, Y, U, C, Re, fe, ve.length, j, E, j), fe = 1, Re++;
          break;
        case 59:
        case 125:
          if (S + ne + le + J === 0) {
              ...
              if (!(0 < ne + J + le))
                switch (S) {
                  case 0:
                    ...
                    break;
                  case 42:
                    $ === 47 && Pe === 42 && Me + 2 !== ce && (P.charCodeAt(Me + 2) === 33 && (ve += P.substring(Me, ce + 1)), fn = "", S = 0);
                }
          }
          S === 0 && (Y += fn);
      }
    ...
    if (Me = ve.length, 0 < Me) {
      if (we = U, 0 < ee && (nt = a(2, ve, we, C, Re, fe, Me, j, E, j), nt !== void 0 && (ve = nt).length === 0))
        return ws + ve + Ps;
      if (ve = we.join(",") + "{" + ve + "}", G * k !== 0) {
        switch (G !== 2 || i(ve, 2) || (k = 0), k) {
          case 111:
            ve = ve.replace(I, ":-moz-$1") + ve;
            break;
          case 112:
            ve = ve.replace(g, "::-webkit-input-$1") + ve.replace(g, "::-moz-$1") + ve.replace(g, ":-ms-input-$1") + ve;
        }
        k = 0;
      }
    }
  ...
  function i(C, U) {
    ...
    return P = C.substring(P + 1, C.length - 1), Ae(U !== 2 ? j : j.replace(w, "$1"), P, U);
  }
  function s(C, U) {
    var P = o(U, U.charCodeAt(0), U.charCodeAt(1), U.charCodeAt(2));
    return P !== U + ";" ? P.replace(M, " or ($1)").substring(4) : "(" + U + ")";
  }
  function a(C, U, P, j, E, J, S, le, ne, me) {
    for (var $ = 0, Pe = U, Ke; $ < ee; ++$)
      switch (Ke = _e[$].call(c, C, Pe, P, j, E, J, S, le, ne, me)) {
        case void 0:
        case !1:
        case !0:
        case null:
  ...
  function _(C) {
    return C = C.prefix, C !== void 0 && (Ae = null, C ? typeof C != "function" ? G = 1 : (G = 2, Ae = C) : G = 0), _;
  }
  function c(C, U) {
    var P = C;
    if (33 > P.charCodeAt(0) && (P = P.trim()), ge = P, P = [ge], 0 < ee) {
      var j = a(-1, U, P, P, Re, fe, 0, 0, 0, 0);
      j !== void 0 && typeof j == "string" && (U = j);
    }
    var E = n(q, P, U, 0, 0);
    return 0 < ee && (j = a(-2, E, P, P, Re, fe, E.length, 0, 0, 0), j !== void 0 && (E = j)), ge = "", k = 0, fe = Re = 1, E;
  }
  var l = /^\0+/g, f = /[\0\r\f]/g, T = /: */g, d = /zoo|gra/, h = /([,: ])(transform)/g, m = /,\r+?/g, O = /([\t\r\n ])*\f?&/g, b = /@(k\w+)\s*(\S*)\s*/, g = /::(place)/g, I = /:(read-only)/g, p = /[svh]\w+-[tblr]{2}/, H = /\(\s*(.*)\s*\)/g, M = /([\s\S]*?);/g, K = /-self|flex-/g, w = /[^]*?(:[rp][el]a[\w-]+)[^]*/, B = /stretch|:\s*\w+\-(?:conte|avail)/, Te = /([^-])(image-set\()/, fe = 1, Re = 1, k = 0, G = 1, q = [], _e = [], ee = 0, Ae = null, He = 0, ge = "";
...
function hb() {
  ...
  return he.AsyncMode = u, he.ConcurrentMode = _, he.ContextConsumer = a, he.ContextProvider = s, he.Element = n, he.ForwardRef = c, he.Fragment = r, he.Lazy = d, he.Memo = T, he.Portal = t, he.Profiler = i, he.StrictMode = o, he.Suspense = l, he.isAsyncMode = function(p) {
    return I(p) || g(p) === u;
    ...
    return typeof p == "string" || typeof p == "function" || p === r || p === _ || p === i || p === o || p === l || p === f || typeof p == "object" && p !== null && (p.$$typeof === d || p.$$typeof === T || p.$$typeof === s || p.$$typeof === a || p.$$typeof === c || p.$$typeof === m || p.$$typeof === O || p.$$typeof === b || p.$$typeof === h);
  }, he.typeOf = g, he;
}
Qd.exports = hb();
var mb = Qd.exports, Eu = mb, fb = {
  childContextTypes: !0,
  contextType: !0,
  contextTypes: !0,
  defaultProps: !0,
...
Ou[Eu.Memo] = Zd;
function il(e) {
  return Eu.isMemo(e) ? Zd : Ou[e.$$typeof] || fb;
}
var Eb = Object.defineProperty, Ob = Object.getOwnPropertyNames, sl = Object.getOwnPropertySymbols, bb = Object.getOwnPropertyDescriptor, Rb = Object.getPrototypeOf, al = Object.prototype;
function eh(e, n, t) {
  if (typeof n != "string") {
    if (al) {
      var r = Rb(n);
...
}, Gb = "style[" + ur + '][data-styled-version="5.3.6"]', Cb = new RegExp("^" + ur + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'), Db = function(e, n, t) {
...
`), r = [], o = 0, i = t.length; o < i; o++) {
    ...
    if (s) {
      ...
      if (a) {
        ...
        u !== 0 && (vb(_, u), Db(e, _, a[3]), e.getTag().insertRules(u, r)), r.length = 0;
      } else
        r.push(s);
    }
  }
...
}(), ll = Ru, Mb = { isServer: !Ru, useCSSOMInjection: !Ib }, th = function() {
  function e(t, r, o) {
    t === void 0 && (t = ft), r === void 0 && (r = {}), this.options = Fn({}, Mb, {}, t), this.gs = r, this.names = new Map(o), this.server = !!t.isServer, !this.server && Ru && ll && (ll = !1, function(i) {
      for (var s = document.querySelectorAll(Gb), a = 0, u = s.length; a < u; a++) {
        var _ = s[a];
        _ && _.getAttribute(ur) !== "active" && (Ub(i, _), _.parentNode && _.parentNode.removeChild(_));
      }
    }(this));
  }
  ...
  return n.reconstructWithOptions = function(t, r) {
    ...
    return this.tag || (this.tag = (o = (r = this.options).isServer, i = r.useCSSOMInjection, s = r.target, t = o ? new wb(s) : i ? new Hb(s) : new Pb(s), new Ab(t)));
    var t, r, o, i, s;
...
function Aa(e) {
  ...
  for (n = Math.abs(e); n > 52; n = n / 52 | 0)
    t = cl(n % 52) + t;
  return (cl(n % 52) + t).replace(kb, "$1-$2");
}
var Xt = function(e, n) {
  for (var t = n.length; t; )
...
var Lb = rh("5.3.6"), Bb = function() {
  function e(n, t, r) {
    this.rules = n, this.staticRulesId = "", this.isStatic = (r === void 0 || r.isStatic) && xb(n), this.componentId = t, this.baseHash = Xt(Lb, t), this.baseStyle = r, th.registerId(t);
  }
...
function Vb(e) {
  var n, t, r, o, i = e === void 0 ? ft : e, s = i.options, a = s === void 0 ? ft : s, u = i.plugins, _ = u === void 0 ? Mi : u, c = new _b(a), l = [], f = function(h) {
    function m(O) {
      if (O)
        try {
          h(O + "}");
    ...
    return function(O, b, g, I, p, H, M, K, w, B) {
      switch (O) {
        case 1:
          if (w === 0 && b.charCodeAt(0) === 64)
            return h(b + ";"), "";
          break;
        case 2:
          if (K === 0)
    ...
    return m === 0 && Fb.indexOf(O[t.length]) !== -1 || O.match(o) ? h : "." + n;
  };
  function d(h, m, O, b) {
    b === void 0 && (b = "&");
    var g = h.replace(jb, ""), I = m && O ? O + " " + m + " { " + g + " }" : g;
    return n = b, t = m, r = new RegExp("\\" + t + "\\b", "g"), o = new RegExp("(\\" + t + "\\b){2,}"), c(O || !m ? "" : m, I);
  }
...
var oh = Se.createContext();
oh.Consumer;
var ih = Se.createContext(), Wb = (ih.Consumer, new th()), Sa = Vb();
function Xb() {
  return Ye(oh) || Wb;
}
function Yb() {
...
}(), $b = /([A-Z])/, zb = /([A-Z])/g, Jb = /^ms-/, qb = function(e) {
  return "-" + e.toLowerCase();
};
function dl(e) {
  return $b.test(e) ? e.replace(zb, qb).replace(Jb, "-ms-") : e;
}
var hl = function(e) {
  return e == null || e === !1 || e === "";
};
function _r(e, n, t, r) {
  ...
  var _;
  return e instanceof Kb ? t ? (e.inject(t, r), e.getName(r)) : e : Ia(e) ? function c(l, f) {
    var T, d, h = [];
    for (var m in l)
      l.hasOwnProperty(m) && !hl(l[m]) && (Array.isArray(l[m]) && l[m].isCss || eo(l[m]) ? h.push(dl(m) + ":", l[m], ";") : Ia(l[m]) ? h.push.apply(h, c(l[m], m)) : h.push(dl(m) + ": " + (T = m, (d = l[m]) == null || typeof d == "boolean" || d === "" ? "" : typeof d != "number" || d === 0 || T in lb ? String(d).trim() : d + "px") + ";"));
...
function In(e) {
  for (var n = arguments.length, t = new Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++)
    t[r - 1] = arguments[r];
  return eo(e) || Ia(e) ? ml(_r(ul(Mi, [e].concat(t)))) : t.length === 0 && e.length === 1 && typeof e[0] == "string" ? e : ml(_r(ul(e, t)));
}
var Qb = function(e, n, t) {
  return t === void 0 && (t = ft), e.theme !== t.theme && e.theme || n || t.theme;
}, Zb = /[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g, eR = /(^-|-$)/g;
function $s(e) {
  return e.replace(Zb, "-").replace(eR, "");
}
var nR = function(e) {
  return Aa(rh(e) >>> 0);
};
...
var gu = Se.createContext();
gu.Consumer;
var zs = {};
function ah(e, n, t) {
  var r = bu(e), o = !Yo(e), i = n.attrs, s = i === void 0 ? Mi : i, a = n.componentId, u = a === void 0 ? function(b, g) {
    var I = typeof b != "string" ? "sc" : $s(b);
    zs[I] = (zs[I] || 0) + 1;
    var p = I + "-" + nR("5.3.6" + I + zs[I]);
    return g ? g + "-" + p : p;
  }(n.displayName, n.parentComponentId) : a, _ = n.displayName, c = _ === void 0 ? function(b) {
    return Yo(b) ? "styled." + b : "Styled(" + _l(b) + ")";
  }(e) : _, l = n.displayName && n.componentId ? $s(n.displayName) + "-" + n.componentId : n.componentId || u, f = r && e.attrs ? Array.prototype.concat(e.attrs, s).filter(Boolean) : s, T = n.shouldForwardProp;
  r && e.shouldForwardProp && (T = n.shouldForwardProp ? function(b, g, I) {
    return e.shouldForwardProp(b, g, I) && n.shouldForwardProp(b, g, I);
  } : e.shouldForwardProp);
  var d, h = new Bb(t, l, r ? e.componentStyle : void 0), m = h.isStatic && s.length === 0, O = function(b, g) {
    return function(I, p, H, M) {
      var K = I.attrs, w = I.componentStyle, B = I.defaultProps, Te = I.foldedComponentIds, fe = I.shouldForwardProp, Re = I.styledComponentId, k = I.target, G = function(j, E, J) {
        j === void 0 && (j = ft);
        var S = Fn({}, E, { theme: j }), le = {};
        return J.forEach(function(ne) {
          var me, $, Pe, Ke = ne;
          for (me in eo(Ke) && (Ke = Ke(S)), Ke)
            S[me] = le[me] = me === "className" ? ($ = le[me], Pe = Ke[me], $ && Pe ? $ + " " + Pe : $ || Pe) : Ke[me];
        }), [S, le];
      }(Qb(p, Ye(gu), B) || ft, p, K), q = G[0], _e = G[1], ee = function(j, E, J, S) {
        var le = Xb(), ne = Yb(), me = E ? j.generateAndInjectStyles(ft, le, ne) : j.generateAndInjectStyles(J, le, ne);
        return me;
      }(w, M, q), Ae = H, He = _e.$as || p.$as || _e.as || p.as || k, ge = Yo(He), C = _e !== p ? Fn({}, p, {}, _e) : p, U = {};
      for (var P in C)
        P[0] !== "$" && P !== "as" && (P === "forwardedAs" ? U.as = C[P] : (fe ? fe(P, rl, He) : !ge || rl(P)) && (U[P] = C[P]));
      return p.style && _e.style !== p.style && (U.style = Fn({}, p.style, {}, _e.style)), U.className = Array.prototype.concat(Te, Re, ee !== Re ? ee : null, p.className, _e.className).filter(Boolean).join(" "), U.ref = Ae, Km(He, U);
    }(d, b, g, m);
  };
  return O.displayName = c, (d = Se.forwardRef(O)).attrs = f, d.componentStyle = h, d.displayName = c, d.shouldForwardProp = T, d.foldedComponentIds = r ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : Mi, d.styledComponentId = l, d.target = r ? e.target : e, d.withComponent = function(b) {
    var g = n.componentId, I = function(H, M) {
      ...
      return B;
    }(n, ["componentId"]), p = g && g + "-" + (Yo(b) ? b : $s(_l(b)));
    return ah(b, Fn({}, I, { attrs: f, componentId: p }), t);
  }, Object.defineProperty(d, "defaultProps", { get: function() {
    return this._foldedDefaultProps;
  }, set: function(b) {
    this._foldedDefaultProps = r ? sh({}, e.defaultProps, b) : b;
  } }), d.toString = function() {
    return "." + d.styledComponentId;
  }, o && Nb(d, e, { attrs: !0, componentStyle: !0, displayName: !0, foldedComponentIds: !0, shouldForwardProp: !0, styledComponentId: !0, target: !0, withComponent: !0 }), d;
}
var Ga = function(e) {
...
`, US = Ie.h1`
  ...
  border-bottom: ${uR} ${Xe("lightGrey")};
`, yS = Ie.div`
  background: ${Xe("lightGrey")};
  ${cn("100%", "2px")};
  margin-bottom: 30px;
  margin-top: -8px;
`, _R = (e, n) => {
  ...
  background: ${Xe("darkBlue")};
  border-top: 2px solid ${Xe("lightGrey")};
  touch-action: none;
  ...
  scroll-behavior: smooth;
  ${Nu()};
`, cR = ({ children: e, onClose: n, isOpen: t, height: r }) => {
  const o = _R(n, r);
  return Ce(() => {
    o.toggle(t);
  }, [t]), /* @__PURE__ */ V(
...
}, dR = (e) => /* @__PURE__ */ V(hu, { children: /* @__PURE__ */ V(cR, { ...e }) }), _h = ({
  onChange: e,
  value: n,
  options: t,
  defaultValue: r
...
}, fR = (e) => /* @__PURE__ */ V(mR, { children: /* @__PURE__ */ V(hR, { ...e }) }), Iu = {
  js: "javascript",
  ts: "typescript",
  tsx: "typescript",
  jsx: "typescript",
  ...
  "go",
  "javascript"
], TR = () => [...new Set(Object.values(Iu))].map((n) => ({
  value: n,
  label: n
})), ER = Qn(() => {
  const e = TR(), n = es(), t = n.getActiveLanguage(), r = n.getActiveTab();
  return /* @__PURE__ */ V(
    _h,
    {
      onChange: (i) => {
...
const IR = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), fl = {
  randomUUID: IR
};
function AR(e, n, t) {
...
const SR = ({
  ...
  key: AR(),
  wasChanged: !1
}), ch = 9, HS = [14, 16, 18, 20, 22, 24, 26], PS = [4, 2], vR = (e) => e.length >= ch;
class GR {
  constructor(n) {
    bt(this), this.state = n;
  }
  createTab(n) {
    const t = this.state.content;
    if (vR(t))
      return null;
    const r = t.at(-1)?.idx, o = SR({ fileData: n, lastNumber: r });
...
`, yR = Qn(() => {
  const { activeKey: e, content: n } = mr(), t = Nt(), r = DR(n), o = CR(), i = o.protect(
    (u, _) => {
      if (_ === "add")
        t.tabs.createTab();
      else {
...
}, wR = (e) => eb(e) ? "name" in e && typeof e.name == "string" && "type" in e && typeof e.type == "string" && "content" in e && typeof e.content == "string" : !1, dh = (e) => {
  const n = e.split(".").at(-1);
  return MR(n) ? [Iu[n], n] : ["text", n];
};
function MR(e) {
  return e in Iu;
}
const hh = {
  ...
  if ("showOpenFilePicker" in window) {
    const [e] = await window.showOpenFilePicker(kR), n = await e.getFile(), t = await n.text(), [r] = dh(n.name);
    return {
      name: n.name,
      type: n.type,
      content: t,
  ...
  try {
    let t = e;
    nb(e?.createWritable) || (t = await window.showSaveFilePicker());
  ...
  const e = xR(), n = LR(), t = Nt(), r = es();
  return {
    openFile: Et(async () => {
      const s = await e();
      wR(s) && t.tabs.createTab(s);
    }, [t.tabs, e]),
    saveFile: async () => {
      ...
      if (!s.wasChanged)
        return;
      const _ = await n(a, u);
      _ && (s.fileHandle = _, s.lang = dh(_.name));
    }
  };
};
...
`, wS = Qn(() => {
  const e = Nt(), { theme: n, content: t, customBackground: r, customColor: o } = mr(), i = _T(), s = iS(), a = BO(() => {
  ...
  }, [r, o]), /* @__PURE__ */ tn(jR, { children: [
    /* @__PURE__ */ tn(FR, { children: [
      /* @__PURE__ */ V(yR, {}),
      /* @__PURE__ */ tn(VR, { children: [
        /* @__PURE__ */ V(bR, {}),
        /* @__PURE__ */ V(ER, {})
      ] })
    ] }),
    /* @__PURE__ */ V(hu, { children: /* @__PURE__ */ V(fR, { onChange: _ }) })
  ] });
});
function WR(e) {
...
function vu(e, n) {
  ...
  if ($e(n._isAMomentObject) || (e._isAMomentObject = n._isAMomentObject), $e(n._i) || (e._i = n._i), $e(n._f) || (e._f = n._f), $e(n._l) || (e._l = n._l), $e(n._strict) || (e._strict = n._strict), $e(n._tzm) || (e._tzm = n._tzm), $e(n._isUTC) || (e._isUTC = n._isUTC), $e(n._offset) || (e._offset = n._offset), $e(n._pf) || (e._pf = z(n)), $e(n._locale) || (e._locale = n._locale), i > 0)
    for (t = 0; t < i; t++)
      r = pl[t], o = n[r], $e(o) || (e[r] = o);
  return e;
}
function Uo(e) {
...
function hi(e, n) {
  return e.isValid() ? (n = Oh(n, e.localeData()), qs[n] = qs[n] || qR(n), qs[n](e)) : e.localeData().invalidDate();
}
function Oh(e, n) {
  var t = 5;
  function r(o) {
...
function ug(e) {
  var n = [], t;
  for (t in e)
    ae(e, t) && n.push({ unit: t, priority: bh[t] });
...
var gh = /\d/, rn = /\d\d/, Nh = /\d{3}/, Uu = /\d{4}/, ds = /[+-]?\d{6}/, Oe = /\d\d?/, Ih = /\d\d\d\d?/, Ah = /\d\d\d\d\d\d?/, hs = /\d{1,3}/, yu = /\d{1,4}/, ms = /[+-]?\d{1,6}/, Tr = /\d+/, fs = /[+-]?\d+/, cg = /Z|[+-]\d\d:?\d\d/gi, ps = /Z|[+-]\d\d(?::?\d\d)?/gi, dg = /[+-]?\d+(\.\d{1,3})?/, yo = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, Li;
Li = {};
function y(e, n, t) {
...
function hg(e, n) {
  return ae(Li, e) ? Li[e](n._strict, n._locale) : new RegExp(mg(e));
}
function mg(e) {
  return nn(
    e.replace("\\", "").replace(
...
var Be = 0, Vn = 1, vn = 2, De = 3, Tn = 4, Wn = 5, St = 6, pg = 7, Tg = 8;
function Eg(e, n) {
  return (e % n + n) % n;
}
var Ge;
Array.prototype.indexOf ? Ge = Array.prototype.indexOf : Ge = function(e) {
  var n;
...
var Og = "January_February_March_April_May_June_July_August_September_October_November_December".split(
  "_"
), Sh = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), vh = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, bg = yo, Rg = yo;
function gg(e, n) {
...
function Ig(e, n, t) {
  ...
  return t ? n === "MMM" ? (o = Ge.call(this._shortMonthsParse, s), o !== -1 ? o : null) : (o = Ge.call(this._longMonthsParse, s), o !== -1 ? o : null) : n === "MMM" ? (o = Ge.call(this._shortMonthsParse, s), o !== -1 ? o : (o = Ge.call(this._longMonthsParse, s), o !== -1 ? o : null)) : (o = Ge.call(this._longMonthsParse, s), o !== -1 ? o : (o = Ge.call(this._shortMonthsParse, s), o !== -1 ? o : null));
}
function Ag(e, n, t) {
  var r, o, i;
  if (this._monthsParseExact)
    return Ig.call(this, e, n, t);
...
function vg(e) {
  return this._monthsParseExact ? (ae(this, "_monthsRegex") || Dh.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (ae(this, "_monthsShortRegex") || (this._monthsShortRegex = bg), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
}
function Gg(e) {
  return this._monthsParseExact ? (ae(this, "_monthsRegex") || Dh.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (ae(this, "_monthsRegex") || (this._monthsRegex = Rg), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
}
function Dh() {
  function e(s, a) {
...
var Lg = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), Hh = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Bg = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), jg = yo, Fg = yo, Vg = yo;
function Wg(e, n) {
...
function Kg(e, n, t) {
  ...
  return t ? n === "dddd" ? (o = Ge.call(this._weekdaysParse, s), o !== -1 ? o : null) : n === "ddd" ? (o = Ge.call(this._shortWeekdaysParse, s), o !== -1 ? o : null) : (o = Ge.call(this._minWeekdaysParse, s), o !== -1 ? o : null) : n === "dddd" ? (o = Ge.call(this._weekdaysParse, s), o !== -1 || (o = Ge.call(this._shortWeekdaysParse, s), o !== -1) ? o : (o = Ge.call(this._minWeekdaysParse, s), o !== -1 ? o : null)) : n === "ddd" ? (o = Ge.call(this._shortWeekdaysParse, s), o !== -1 || (o = Ge.call(this._weekdaysParse, s), o !== -1) ? o : (o = Ge.call(this._minWeekdaysParse, s), o !== -1 ? o : null)) : (o = Ge.call(this._minWeekdaysParse, s), o !== -1 || (o = Ge.call(this._weekdaysParse, s), o !== -1) ? o : (o = Ge.call(this._shortWeekdaysParse, s), o !== -1 ? o : null));
}
function $g(e, n, t) {
  var r, o, i;
  if (this._weekdaysParseExact)
    return Kg.call(this, e, n, t);
...
function zg(e) {
  ...
  return e != null ? (e = kg(e, this.localeData()), this.add(e - n, "d")) : n;
}
function Jg(e) {
  if (!this.isValid())
    return e != null ? this : NaN;
...
function qg(e) {
  if (!this.isValid())
    return e != null ? this : NaN;
  if (e != null) {
    var n = xg(e, this.localeData());
    return this.day(this.day() % 7 ? n : n - 7);
  } else
    return this.day() || 7;
}
function Qg(e) {
  return this._weekdaysParseExact ? (ae(this, "_weekdaysRegex") || Pu.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (ae(this, "_weekdaysRegex") || (this._weekdaysRegex = jg), this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex);
}
function Zg(e) {
  return this._weekdaysParseExact ? (ae(this, "_weekdaysRegex") || Pu.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (ae(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Fg), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
}
function eN(e) {
  return this._weekdaysParseExact ? (ae(this, "_weekdaysRegex") || Pu.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (ae(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Vg), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
}
function Pu() {
  function e(c, l) {
  ...
  for (i = 0; i < 7; i++)
    s = Mn([2e3, 1]).day(i), a = nn(this.weekdaysMin(s, "")), u = nn(this.weekdaysShort(s, "")), _ = nn(this.weekdays(s, "")), n.push(a), t.push(u), r.push(_), o.push(a), o.push(u), o.push(_);
...
function Es(e) {
  var n = null, t;
  if (be[e] === void 0 && typeof module < "u" && module && module.exports && uN(e))
    try {
      n = ro._abbr, t = WR, t("./locale/" + e), pt(n);
    } catch {
      be[e] = null;
    }
  return be[e];
...
function pt(e, n) {
  var t;
  return e && ($e(n) ? t = Zn(e) : t = Mu(e, n), t ? ro = t : typeof console < "u" && console.warn && console.warn(
...
function Mu(e, n) {
  if (n !== null) {
    ...
    if (n.abbr = e, be[e] != null)
      ...
      if (be[n.parentLocale] != null)
        r = be[n.parentLocale]._config;
    ...
    return be[e] = new Gu(Ua(r, n)), Ar[e] && Ar[e].forEach(function(o) {
      Mu(o.name, o.config);
    }), pt(e), be[e];
  } else
...
function _N(e, n) {
  if (n != null) {
    var t, r, o = Mh;
    be[e] != null && be[e].parentLocale != null ? be[e].set(Ua(be[e]._config, n)) : (r = Es(e), r != null && (o = r._config), n = Ua(o, n), r == null && (n.abbr = e), t = new Gu(n), t.parentLocale = be[e], be[e] = t), pt(e);
  } else
    be[e] != null && (be[e].parentLocale != null ? (be[e] = be[e].parentLocale, e === pt() && pt(e)) : be[e] != null && delete be[e]);
  return be[e];
}
function Zn(e) {
  var n;
...
function ku(e) {
  var n, t = e._a;
  return t && z(e).overflow === -2 && (n = t[Vn] < 0 || t[Vn] > 11 ? Vn : t[vn] < 1 || t[vn] > Ts(t[Be], t[Vn]) ? vn : t[De] < 0 || t[De] > 24 || t[De] === 24 && (t[Tn] !== 0 || t[Wn] !== 0 || t[St] !== 0) ? De : t[Tn] < 0 || t[Tn] > 59 ? Tn : t[Wn] < 0 || t[Wn] > 59 ? Wn : t[St] < 0 || t[St] > 999 ? St : -1, z(e)._overflowDayOfYear && (n < Be || n > vn) && (n = vn), z(e)._overflowWeeks && n === -1 && (n = pg), z(e)._overflowWeekday && n === -1 && (n = Tg), z(e).overflow = n), e;
}
var cN = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/, dN = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d|))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/, hN = /Z|[+-]\d\d(?::?\d\d)?/, zo = [
  ...
  ["HHmm", /\d\d\d\d/],
  ["HH", /\d\d/]
], mN = /^\/?Date\((-?\d+)/i, fN = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/, pN = {
  UT: 0,
  GMT: 0,
  EDT: -4 * 60,
  EST: -5 * 60,
...
function kh(e) {
  var n, t, r = e._i, o = cN.exec(r) || dN.exec(r), i, s, a, u, _ = zo.length, c = Qs.length;
  if (o) {
...
function xh(e) {
  ...
  if (n) {
    if (t = TN(
      ...
      return;
    e._a = t, e._tzm = RN(n[8], n[9], n[10]), e._d = no.apply(null, e._a), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), z(e).rfc2822 = !0;
  } else
    e._isValid = !1;
}
function gN(e) {
...
function xu(e) {
  var n, t, r = [], o, i, s;
  if (!e._d) {
    for (o = NN(e), e._w && e._a[vn] == null && e._a[Vn] == null && IN(e), e._dayOfYear != null && (s = Bt(e._a[Be], o[Be]), (e._dayOfYear > Br(s) || e._dayOfYear === 0) && (z(e)._overflowDayOfYear = !0), t = no(s, 0, e._dayOfYear), e._a[Vn] = t.getUTCMonth(), e._a[vn] = t.getUTCDate()), n = 0; n < 3 && e._a[n] == null; ++n)
      e._a[n] = r[n] = o[n];
    for (; n < 7; n++)
      e._a[n] = r[n] = e._a[n] == null ? n === 2 ? 1 : 0 : e._a[n];
    e._a[De] === 24 && e._a[Tn] === 0 && e._a[Wn] === 0 && e._a[St] === 0 && (e._nextDay = !0, e._a[De] = 0), e._d = (e._useUTC ? no : Dg).apply(
      null,
      r
...
function Lu(e) {
  ...
  for (o = Oh(e._f, e._locale).match(Cu) || [], c = o.length, t = 0; t < c; t++)
    i = o[t], r = (n.match(hg(i, e)) || [])[0], r && (s = n.substr(0, n.indexOf(r)), s.length > 0 && z(e).unusedInput.push(s), n = n.slice(
      n.indexOf(r) + r.length
    ), u += r.length), $t[i] ? (r ? z(e).empty = !1 : z(e).unusedTokens.push(i), fg(i, r, e)) : e._strict && !r && z(e).unusedTokens.push(i);
  z(e).charsLeftOver = a - u, n.length > 0 && z(e).unusedInput.push(n), e._a[De] <= 12 && z(e).bigHour === !0 && e._a[De] > 0 && (z(e).bigHour = void 0), z(e).parsedDateParts = e._a.slice(0), z(e).meridiem = e._meridiem, e._a[De] = AN(
    e._locale,
    e._a[De],
    e._meridiem
...
function Lh(e) {
  var n = e._i, t = e._f;
  return e._locale = e._locale || Zn(e._l), n === null || t === void 0 && n === "" ? ls({ nullInput: !0 }) : (typeof n == "string" && (e._i = n = e._locale.preparse(n)), Nn(n) ? new Uo(ku(n)) : (Do(n) ? e._d = n : gn(t) ? SN(e) : t ? Lu(e) : CN(e), Su(e) || (e._d = null), e));
}
function CN(e) {
  var n = e._i;
  $e(n) ? e._d = new Date(D.now()) : Do(n) ? e._d = new Date(n.valueOf()) : typeof n == "string" ? gN(e) : gn(n) ? (e._a = ph(n.slice(0), function(t) {
    return parseInt(t, 10);
  }), xu(e)) : Gt(n) ? vN(e) : Jn(n) ? e._d = new Date(n) : D.createFromInputFallback(e);
}
function Bh(e, n, t, r, o) {
  var i = {};
  return (n === !0 || n === !1) && (r = n, n = void 0), (t === !0 || t === !1) && (r = t, t = void 0), (Gt(e) && Au(e) || gn(e) && e.length === 0) && (e = void 0), i._isAMomentObject = !0, i._useUTC = i._isUTC = o, i._l = t, i._i = e, i._f = n, i._strict = r, GN(i);
}
function Ee(e, n, t, r) {
  return Bh(e, n, t, r, !1);
}
...
function wN(e) {
  ...
  for (n in e)
    if (ae(e, n) && !(Ge.call(Sr, n) !== -1 && (e[n] == null || !isNaN(e[n]))))
      return !1;
  for (r = 0; r < o; ++r)
    if (e[Sr[r]]) {
      if (t)
...
function Os(e) {
  ...
  this._isValid = wN(n), this._milliseconds = +c + _ * 1e3 + // 1000
  u * 6e4 + // 1000 * 60
...
function Bu(e, n) {
  ...
  return t === null ? null : (r = t[t.length - 1] || [], o = (r + "").match(LN) || ["-", 0, 0], i = +(o[1] * 60) + Q(o[2]), i === 0 ? 0 : o[0] === "+" ? i : -i);
}
function ju(e, n) {
  var t, r;
...
function BN(e, n, t) {
  ...
  if (e != null) {
    ...
    return !this._isUTC && n && (o = wa(this)), this._offset = e, this._isUTC = !0, o != null && this.add(o, "m"), r !== e && (!n || this._changeInProgress ? Xh(
      this,
      An(e - r, "m"),
      1,
      !1
...
function KN() {
  ...
  var e = {}, n;
  return vu(e, this), e = Lh(e), e._a ? (n = e._isUTC ? Mn(e._a) : Ee(e._a), this._isDSTShifted = this.isValid() && xN(e._a, n.toArray()) > 0) : this._isDSTShifted = !1, this._isDSTShifted;
}
function $N() {
...
var JN = /^(-|\+)?(?:(\d*)[. ])?(\d+):(\d+)(?::(\d+)(\.\d*)?)?$/, qN = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;
function An(e, n) {
  ...
  return mi(e) ? t = {
    ...
    d: e._days,
    M: e._months
  } : Jn(e) || !isNaN(+e) ? (t = {}, n ? t[n] = +e : t.milliseconds = +e) : (r = JN.exec(e)) ? (o = r[1] === "-" ? -1 : 1, t = {
    y: 0,
    d: Q(r[vn]) * o,
    h: Q(r[De]) * o,
    m: Q(r[Tn]) * o,
    ...
    m: It(r[7], o),
    s: It(r[8], o)
  }) : t == null ? t = {} : typeof t == "object" && ("from" in t || "to" in t) && (s = QN(
    Ee(t.from),
    Ee(t.to)
...
function Xh(e, n, t, r) {
  ...
  e.isValid() && (r = r ?? !0, s && Gh(e, xi(e, "Month") + s * t), i && Rh(e, "Date", xi(e, "Date") + i * t), o && e._d.setTime(e._d.valueOf() + o * t), r && D.updateOffset(e, i || s));
}
var ZN = Wh(1, "add"), e1 = Wh(-1, "subtract");
function Yh(e) {
  return typeof e == "string" || e instanceof String;
}
function n1(e) {
  return Nn(e) || Do(e) || Yh(e) || Jn(e) || r1(e) || t1(e) || e === null || e === void 0;
}
function t1(e) {
...
function s1(e, n) {
  arguments.length === 1 && (arguments[0] ? n1(arguments[0]) ? (e = arguments[0], n = void 0) : o1(arguments[0]) && (n = arguments[0], e = void 0) : (e = void 0, n = void 0));
...
function Vu() {
  ...
  for (o = 0, i = s.length; o < i; ++o)
    n.push(nn(s[o].name)), e.push(nn(s[o].abbr)), t.push(nn(s[o].narrow)), r.push(nn(s[o].name)), r.push(nn(s[o].abbr)), r.push(nn(s[o].narrow));
...
function Zh(e, n, t, r, o) {
  var i;
  return e == null ? to(this, r, o).year : (i = $n(e, r, o), n > i && (n = i), eI.call(this, e, n, t, r, o));
}
function eI(e, n, t, r, o) {
  var i = yh(e, n, t, r, o), s = no(i.year, 0, i.dayOfYear);
...
A.weekYear = $1;
A.isoWeekYear = z1;
A.quarter = A.quarters = nI;
A.month = Ch;
A.daysInMonth = Sg;
A.week = A.weeks = wg;
A.isoWeek = A.isoWeeks = Mg;
A.weeksInYear = Q1;
A.weeksInWeekYear = Z1;
A.isoWeeksInYear = J1;
A.isoWeeksInISOWeekYear = q1;
A.date = em;
A.day = A.days = zg;
A.weekday = Jg;
A.isoWeekday = qg;
A.dayOfYear = tI;
A.hour = A.hours = oN;
A.minute = A.minutes = rI;
A.second = A.seconds = oI;
A.millisecond = A.milliseconds = nm;
A.utcOffset = BN;
A.utc = FN;
A.local = VN;
A.parseZone = WN;
A.hasAlignedHourOffset = XN;
A.isDST = YN;
A.isLocal = $N;
A.isUtcOffset = zN;
A.isUtc = Vh;
...
ue.eras = w1;
ue.erasParse = M1;
ue.erasConvertYear = k1;
ue.erasAbbrRegex = V1;
ue.erasNameRegex = F1;
ue.erasNarrowRegex = W1;
ue.months = gg;
ue.monthsShort = Ng;
ue.monthsParse = Ag;
ue.monthsRegex = Gg;
ue.monthsShortRegex = vg;
ue.week = Ug;
ue.firstDayOfYear = Pg;
ue.firstDayOfWeek = Hg;
ue.weekdays = Wg;
ue.weekdaysMin = Yg;
ue.weekdaysShort = Xg;
ue.weekdaysParse = $g;
ue.weekdaysRegex = Qg;
ue.weekdaysShortRegex = Zg;
ue.weekdaysMinRegex = eN;
ue.isPM = tN;
ue.meridiem = iN;
function Vi(e, n, t, r) {
...
function EI() {
  ...
  return e >= 0 && n >= 0 && t >= 0 || e <= 0 && n <= 0 && t <= 0 || (e += bl(Ma(t) + n) * 864e5, n = 0, t = 0), r.milliseconds = e % 1e3, o = on(e / 1e3), r.seconds = o % 60, i = on(o / 60), r.minutes = i % 60, s = on(i / 60), r.hours = s % 24, n += on(s / 24), u = on(im(n)), t += u, n -= bl(Ma(u)), a = on(t / 12), t %= 12, r.days = n, r.months = t, r.years = a, this;
}
function im(e) {
...
var RI = et("ms"), gI = et("s"), NI = et("m"), II = et("h"), AI = et("d"), SI = et("w"), vI = et("M"), GI = et("Q"), CI = et("y");
function DI() {
  return An(this);
}
function UI(e) {
...
var yI = Pt("milliseconds"), HI = Pt("seconds"), PI = Pt("minutes"), wI = Pt("hours"), MI = Pt("days"), kI = Pt("months"), xI = Pt("years");
function LI() {
...
function jI(e, n, t, r) {
  var o = An(e).abs(), i = Ln(o.as("s")), s = Ln(o.as("m")), a = Ln(o.as("h")), u = Ln(o.as("d")), _ = Ln(o.as("M")), c = Ln(o.as("w")), l = Ln(o.as("y")), f = i <= t.ss && ["s", i] || i < t.s && ["ss", i] || s <= 1 && ["m"] || s < t.m && ["mm", s] || a <= 1 && ["h"] || a < t.h && ["hh", a] || u <= 1 && ["d"] || u < t.d && ["dd", u];
  return t.w != null && (f = f || c <= 1 && ["w"] || c < t.w && ["ww", c]), f = f || _ <= 1 && ["M"] || _ < t.M && ["MM", _] || l <= 1 && ["y"] || ["yy", l], f[2] = n, f[3] = +e > 0, f[4] = r, BI.apply(null, f);
}
function FI(e) {
...
function WI(e, n) {
  ...
  var t = !1, r = Yt, o, i;
  return typeof e == "object" && (n = e, e = !1), typeof e == "boolean" && (t = e), typeof n == "object" && (r = Object.assign({}, Yt, n), n.s != null && n.ss == null && (r.ss = n.s - 1)), o = this.localeData(), i = jI(this, !t, r, o), t && (i = o.pastFuture(+this, i)), o.postformat(i);
}
var Zs = Math.abs;
function Mt(e) {
  return (e > 0) - (e < 0) || +e;
...
D.weekdaysShort = hI;
D.normalizeUnits = mn;
D.relativeTimeRounding = FI;
D.relativeTimeThreshold = VI;
D.calendarFormat = i1;
D.prototype = A;
D.HTML5_FMT = {
...
class XI {
  constructor(n) {
    bt(this), this.state = n, this.getters = n.getters, this.storage = n.storage;
  }
  addExecuteMessage(n) {
    console.log(n);
...
`, $I = Ie.span`
  ...
  font-size: ${({ theme: e }) => e.fz7};
  em {
    color: ${({ $isError: e }) => e ? "red" : Xe("light")};
    font-weight: bold;
    font-style: italic;
  }
`, zI = Zt(
  ({ children: e }, n) => {
    ...
    })), /* @__PURE__ */ V(KI, { ref: t, children: e });
  }
), JI = Qn(
  Zt((e, n) => {
    const t = Z(null), r = Z(null), { isTerminalOpened: o } = sT(), { executeMessages: i } = mr(), { spring: s, SpringDiv: a } = YI(n), u = () => {
      r.current.scrollIntoView({ behavior: "smooth" });
    };
    return Ce(() => {
      t.current.scrollToBottom();
    }, [i.length, o]), /* @__PURE__ */ tn(zI, { ref: t, children: [
      "CodeGear output console.",
      /* @__PURE__ */ tn(a, { style: { ...s }, children: [
        i.map((_, c) => /* @__PURE__ */ tn(
          $I,
          {
            $isError: _.isError,
            onClick: u,
  ...
  svg {
    path {
      stroke: ${Xe("secondaryGrey")};
      ${({ theme: e }) => Ca(e.light)};
    }
    ${cn("22px")}
    color: ${Xe("secondaryGrey")};
    ${({ theme: e }) => Ca(e.light)}
  }
`, eA = Ie(rc)`
  ${sR(0, 6)};
...
`, MS = Qn(() => {
  ...
  return /* @__PURE__ */ tn(dR, { onClose: s, isOpen: n, height: 300, children: [
    /* @__PURE__ */ V(
      eA,
      {
        items: t.val,
    ...
    /* @__PURE__ */ V(ba, { when: t.key === "terminal", children: /* @__PURE__ */ V(JI, { ref: o }) }),
    /* @__PURE__ */ V(ba, { when: t.key === "test_cases", children: /* @__PURE__ */ V(nA, { children: "Test cases are not supported yet." }) }),
    /* @__PURE__ */ tn(ZI, { children: [
      /* @__PURE__ */ V(sb, { onClick: a }),
      /* @__PURE__ */ V(ib, { onClick: s })
    ] })
  ] });
});
class tA {
  constructor(n) {
    bt(this), this.state = n, this.getters = n.getters, this.tabs = new GR(n), this.editor = new Yp(n), this.terminal = new XI(n);
  }
  changeTheme(n) {
...
class rA {
  ...
  isAllowedToExecute() {
    ...
    return pR.includes(n);
  }
}
const oA = `// Hello World! Here you can edit the code in 10 different languages. 😎
...
const uA = ({
  ...
  createTab: t,
  runCode: r
}) => /* @__PURE__ */ tn(aA, { children: [
  /* @__PURE__ */ V(nf, { to: xO.MAIN, children: /* @__PURE__ */ V("img", { src: sA, alt: "" }) }),
...
const cA = Qn(
  ({ isDisabled: e, runCode: n, openSignIn: t }) => {
    const r = oR();
    return /* @__PURE__ */ tn(lA, { children: [
      /* @__PURE__ */ V(
        nl,
        {
          type: "primary",
...
class hA {
  constructor(n) {
    bt(this), this.state = n, this.getters = n.getters, this.actions = n.actions;
  }
  async requestCodeExecution() {
    const { NOT_SUPPORTED: n, ERRORS_IN_CODE: t, SUCCESS: r, NETWORK_ERROR: o } = dA;
...
X.setTimeout = (e, n) => {
  ...
  return qt.splice(sm(t), 0, o), ct += 1, am(), o;
};
var sm = (e) => ~(~qt.findIndex((n) => n.time > e) || ~qt.length);
X.cancel = (e) => {
...
var EA = (e, n, t) => Object.defineProperty(e, n, { value: t, writable: !0, configurable: !0 }), N = {
  arr: Array.isArray,
...
var Pr = (e, ...n) => jr(e, (t) => t(...n)), Ju = () => typeof window > "u" || !window.navigator || /ServerSideRendering|^Deno\//.test(window.navigator.userAgent), qu, cm, Tt = null, dm = !1, Qu = xa, hm = (e) => {
  ...
  start(e) {
    Wi > e.priority ? (Fr.add(e), X.onStart(OA)) : (mm(e), X(La));
  },
...
var NA = new RegExp("rgb" + Ns(En, En, En)), IA = new RegExp("rgba" + Ns(En, En, En, En)), AA = new RegExp("hsl" + Ns(En, Xi, Xi)), SA = new RegExp(
  "hsla" + Ns(En, Xi, Xi, En)
), vA = /^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, GA = /^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, CA = /^#([0-9a-fA-F]{6})$/, DA = /^#([0-9a-fA-F]{8})$/;
function UA(e) {
  let n;
  return typeof e == "number" ? e >>> 0 === e && e >= 0 && e <= 4294967295 ? e : null : (n = CA.exec(e)) ? parseInt(n[1] + "ff", 16) >>> 0 : Tt && Tt[e] !== void 0 ? Tt[e] : (n = NA.exec(e)) ? (kt(n[1]) << 24 | // r
  kt(n[2]) << 16 | // g
  kt(n[3]) << 8 | // b
  255) >>> // a
  0 : (n = IA.exec(e)) ? (kt(n[1]) << 24 | // r
  kt(n[2]) << 16 | // g
  kt(n[3]) << 8 | // b
  Nl(n[4])) >>> // a
...
var PA = (e, n = "end") => (t) => {
  ...
  steps: PA
}, oo = Symbol.for("FluidValue.get"), cr = Symbol.for("FluidValue.observers"), sn = (e) => !!(e && e[oo]), ze = (e) => e && e[oo] ? e[oo]() : e, Gl = (e) => e[cr] || null;
function wA(e, n) {
...
var Em = (e, n, t) => Object.defineProperty(e, n, {
  ...
  writable: !0,
  configurable: !0
}), pi = /[+\-]?(?:0|[1-9]\d*)(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, kA = /(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d\.]+%?\))/gi, Cl = new RegExp(`(${pi.source})(%|[a-z]+)`, "i"), xA = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi, Is = /var\((--[a-zA-Z0-9-_]+),? ?([a-zA-Z0-9 ()%#.,-]+)?\)/, Om = (e) => {
  const [n, t] = LA(e);
  if (!n || Ju())
    return e;
  ...
  const [, t, r] = n;
  return [t, r];
}, ta, BA = (e, n, t, r, o) => `rgba(${Math.round(n)}, ${Math.round(t)}, ${Math.round(r)}, ${o})`, bm = (e) => {
  ta || (ta = Tt ? (
  ...
  const n = e.output.map((i) => ze(i).replace(Is, Om).replace(kA, Il).replace(ta, Il)), t = n.map((i) => i.match(pi).map(Number)), o = t[0].map(
    (i, s) => t.map((a) => {
      if (!(s in a))
...
var xt, Ti = /* @__PURE__ */ new WeakMap(), WA = (e) => e.forEach(({ target: n, contentRect: t }) => Ti.get(n)?.forEach((r) => r(t)));
function XA(e, n) {
...
var Ei = /* @__PURE__ */ new Set(), vr, YA = () => {
...
}, KA = (e) => (Ei.add(e), vr || (vr = YA()), () => {
  Ei.delete(e), !Ei.size && vr && (vr(), vr = void 0);
}), Nm = (e, { container: n = document.documentElement } = {}) => n === document.documentElement ? KA(e) : XA(e, n), $A = (e, n, t) => n - e === 0 ? 1 : (t - e) / (n - e), zA = {
  x: {
    length: "Width",
    position: "Left"
  },
...
}, Gr = /* @__PURE__ */ new WeakMap(), Dl = /* @__PURE__ */ new WeakMap(), ra = /* @__PURE__ */ new WeakMap(), Ul = (e) => e === document.documentElement ? window : e, qA = (e, { container: n = document.documentElement } = {}) => {
  let t = ra.get(n);
  ...
  if (t.add(r), !Gr.has(n)) {
    ...
    Gr.set(n, i);
    const s = Ul(n);
    window.addEventListener("resize", i, { passive: !0 }), n !== document.documentElement && Dl.set(n, Nm(i, { container: n })), s.addEventListener("scroll", i, { passive: !0 });
  }
  const o = Gr.get(n);
  return X(o), () => {
    X.cancel(o);
...
function e0(e, n) {
  ...
  let i = o;
  return i ? n && i.inputs && n0(n, i.inputs) || (i = {
    inputs: n,
    result: e()
  }) : i = t, Ce(() => {
...
var r0 = () => {
...
}, ao = Symbol.for("Animated:node"), o0 = (e) => !!e && e[ao] === e, Sn = (e) => e && e[ao], n_ = (e, n) => EA(e, ao, n), vs = (e) => e && e[ao] && e[ao].getPayload(), Im = class {
  constructor() {
    n_(this, this);
  }
...
}, Ki = { dependencies: null }, Gs = class extends Im {
  constructor(e) {
  ...
  getValue(e) {
    ...
    return Pn(this.source, (t, r) => {
      o0(t) ? n[r] = t.getValue(e) : sn(t) ? n[r] = ze(t) : e || (n[r] = t);
    }), n;
  }
  ...
  setValue(e) {
    ...
    return e.length == n.length ? n.map((t, r) => t.setValue(e[r])).some(Boolean) : (super.setValue(e.map(i0)), !0);
  }
};
function i0(e) {
...
function ja(e) {
  const n = Sn(e);
  return n ? n.constructor : N.arr(e) ? Am : As(e) ? uo : ko;
}
var yl = (e, n) => {
  const t = (
...
var Hl = Symbol.for("AnimatedComponent"), _0 = (e, {
...
}, Pl = (e) => N.str(e) ? e : e && N.str(e.displayName) ? e.displayName : N.fun(e) && e.name || null, l0 = class {
};
function Ve(e, ...n) {
  return N.fun(e) ? e(...n) : e;
}
var Vr = (e, n) => e === !0 || !!(n && e && (N.fun(e) ? e(n) : We(e).includes(n))), Sm = (e, n) => N.obj(e) ? n && e[n] : e, vm = (e, n) => e.default === !0 ? e[n] : e.default ? e.default[n] : void 0, c0 = (e) => e, Cs = (e, n = c0) => {
  let t = d0;
...
function _o(e) {
  return e = ze(e), N.arr(e) ? e.map(_o) : As(e) ? dn.createStringInterpolator({
    range: [0, 1],
    output: [e, e]
  })(1) : e;
}
...
var Ml = [], E0 = class {
  constructor() {
    this.changed = !1, this.values = Ml, this.toValues = null, this.fromValues = Ml, this.config = new p0(), this.immediate = !1;
  }
};
  ...
  return !i && e === a && !n.reset ? u : t.promise = (async () => {
    ...
    const f = new Promise(
      ...
      return (async () => {
        ...
        return T(b), t.paused && await new Promise((H) => {
          t.resumeQueue.add(H);
        }), p;
      })();
    };
...
var Xa = class extends Error {
...
}, Ya = (e) => e instanceof Us, O0 = 1, Us = class extends Tm {
  constructor() {
    super(...arguments), this.id = O0++, this._priority = 0;
  }
  get priority() {
...
}, Dt = Symbol.for("SpringPhase"), Hm = 1, Ka = 2, $a = 4, oa = (e) => (e[Dt] & Hm) > 0, rt = (e) => (e[Dt] & Ka) > 0, Cr = (e) => (e[Dt] & $a) > 0, xl = (e, n) => n ? e[Dt] |= Ka | Hm : e[Dt] &= ~Ka, Ll = (e, n) => n ? e[Dt] |= $a : e[Dt] &= ~$a, o_ = class extends Us {
  constructor(e, n) {
    if (super(), this.animation = new E0(), this.defaultProps = {}, this._state = {
      paused: !1,
      delayed: !1,
  ...
  advance(e) {
    ...
    !s && sn(r.to) && (o = We(ze(r.to))), r.values.forEach((_, c) => {
      if (_.done)
        return;
      const l = (
      ...
      if (!f) {
        ...
        let O;
        const b = i.precision || (h == l ? 5e-3 : Math.min(1, Math.abs(l - h) * 1e-3));
        if (N.und(i.duration))
          if (i.decay) {
            const g = i.decay === !0 ? 0.998 : i.decay, I = Math.exp(-(1 - g) * d);
            T = h + m / (1 - g) * (1 - I), f = Math.abs(_.lastPosition - T) <= b, O = m * I;
          } else {
            O = _.lastVelocity == null ? m : _.lastVelocity;
            const g = i.restVelocity || b / 10, I = i.clamp ? 0 : i.bounce, p = !N.und(I), H = h == l ? _.v0 > 0 : h < l;
            let M, K = !1;
            const w = 1, B = Math.ceil(e / w);
            for (let Te = 0; Te < B && (M = Math.abs(O) > g, !(!M && (f = Math.abs(l - T) <= b, f))); ++Te) {
              p && (K = T == l || T > l == H, K && (O = -O * I, T = l));
              const fe = -i.tension * 1e-6 * (T - l), Re = -i.friction * 1e-3 * O, k = (fe + Re) / i.mass;
              O = O + k * w, T = T + O * w;
            }
          }
        else {
  ...
  _prepareNode(e) {
    ...
    const o = { to: t, from: r };
    return oa(this) || (e.reverse && ([t, r] = [r, t]), r = ze(r), N.und(r) ? Sn(this) || this._set(t) : this._set(r)), o;
  }
  ...
  _merge(e, n, t) {
    ...
    (r || o) && (h.velocity = 0), n.config && !d && T0(
      h,
      Ve(n.config, i),
    ...
    if (T) {
      ...
      if (Te !== b.constructor)
        if (M)
          ...
          throw Error(
            `Cannot animate between ${b.constructor.name} and ${Te.name}, as the "to" prop suggests`
          );
    }
    const K = b.constructor;
    let w = sn(c), B = !1;
    if (!w) {
      const Te = g || !oa(this) && f;
      (T || Te) && (B = Bn(_o(I), p), w = !B), (!Bn(a.immediate, M) && !M || !Bn(h.decay, m) || !Bn(h.velocity, O)) && (w = !0);
    }
    if (B && rt(this) && (a.changed && !g ? w = !0 : w || this._stop(u)), !d && ((w || sn(u)) && (a.values = b.getPayload(), a.toValues = sn(c) ? null : K == uo ? [1] : We(p)), a.immediate != M && (a.immediate = M, !M && !g && this._set(u)), w)) {
      const { onRest: Te } = a;
      L(R0, (Re) => jl(this, n, Re));
      const fe = pn(this, Dr(this, u));
      Pr(this._pendingCalls, fe), this._pendingCalls.add(t), a.changed && X.batchedUpdates(() => {
        a.changed = !g, Te?.(fe, this), g ? Ve(s.onRest, fe) : a.onStart?.(fe, this);
      });
    }
  ...
  _start() {
    const e = this.animation;
    Sn(this).reset(ze(e.to)), e.immediate || (e.fromValues = e.values.map((n) => n.lastPosition)), rt(this) || (xl(this, !0), Cr(this) || this._resume());
  }
  _resume() {
...
var g0 = ["onStart", "onChange", "onRest"], N0 = 1, i_ = class {
  constructor(e, n) {
    this.id = N0++, this.springs = {}, this.queue = [], this._lastAsyncId = 0, this._active = /* @__PURE__ */ new Set(), this._changed = /* @__PURE__ */ new Set(), this._started = !1, this._state = {
      paused: !1,
      pauseQueue: /* @__PURE__ */ new Set(),
      resumeQueue: /* @__PURE__ */ new Set(),
      timeouts: /* @__PURE__ */ new Set()
  ...
  start(e) {
    let { queue: n } = this;
    return e ? n = We(e).map(co) : this.queue = [], this._flush ? this._flush(this, n) : (Lm(this, n), za(this, n));
  }
  /** @internal */
  stop(e, n) {
    if (e !== !!e && (n = e), n) {
...
async function wm(e, n, t) {
  ...
  c ? (n.to = void 0, n.onRest = void 0, _ && (_.onRest = void 0)) : L(g0, (h) => {
    const m = n[h];
    if (N.fun(m)) {
      const O = e._events[h];
      n[h] = ({ finished: b, cancelled: g }) => {
        const I = O.get(m);
        I ? (b || (I.finished = !1), g && (I.cancelled = !0)) : O.set(m, {
          value: null,
          finished: b || !1,
          cancelled: g || !1
        });
  ...
  (c || T && l.asyncId) && f.push(
    Dm(++e._lastAsyncId, {
      ...
      actions: {
        ...
        resume: xa,
        start(h, m) {
          T ? (lo(l, e._lastAsyncId), m(Qt(e))) : (h.onRest = a, m(
            ym(
              c,
              h,
              l,
...
var Or = ({
  ...
  const t = Ye($i), r = n.pause || !!t.pause, o = n.immediate || !!t.immediate;
  n = e0(() => ({ pause: r, immediate: o }), [r, o]);
  const { Provider: i } = $i;
...
function s_(e, n, t) {
  ...
  const o = it(
    ...
    () => ({
      ...
      flush(O, b) {
        const g = Ja(O, b);
        return i.current > 0 && !a.queue.length && !Object.keys(g).some((p) => !O.springs[p]) ? za(O, b) : new Promise((p) => {
          Mm(O, g), a.queue.push(() => {
            p(za(O, b));
          }), s();
        });
  ...
  const f = u.current.map((O, b) => Ja(O, _[b])), T = Ye(Or), d = Ba(T), h = T !== d && Gm(T);
  Qe(() => {
    i.current++, a.ctrls = u.current;
    const { queue: O } = a;
    O.length && (a.queue = [], L(O, (b) => b())), L(u.current, (b, g) => {
      o?.add(b), h && b.start({ default: T });
      const I = _[g];
      I && (t_(b, I.ref), b.ref ? b.queue.push(I) : b.start(I));
    });
  }), Ss(() => () => {
...
function jm(e, n, t) {
  ...
  const O = C0(T, r ? r() : n, m), b = o && h.current || [];
  Qe(
    () => L(b, ({ ctrl: k, item: G, key: q }) => {
      Va(k, f), Ve(_, G, q);
    })
  );
  const g = [];
  if (m && L(m, (k, G) => {
    k.expired ? (clearTimeout(k.expirationId), b.push(k)) : (G = g[G] = O.indexOf(k.key), ~G && (d[G] = k));
  }), L(T, (k, G) => {
    d[G] || (d[G] = {
      key: O[G],
      item: k,
  ...
  L(d, (k, G) => {
    ...
    if (_e == "mount")
      Ae = ee.enter, He = "enter";
    else {
      const j = O.indexOf(q) < 0;
      if (_e != "leave")
        if (j)
          Ae = ee.leave, He = "leave";
        else if (Ae = ee.update)
          He = "update";
        else
          return;
      else if (!j)
    ...
    if (Ae = Ve(Ae, k.item, G), Ae = N.obj(Ae) ? Ds(Ae) : { to: Ae }, !Ae.config) {
      const j = l || H.config;
      Ae.config = Ve(j, k.item, G, He);
    }
    I += s;
    const C = {
      ...H,
  ...
  const B = Ye(Or), Te = Ba(B), fe = B !== Te && Gm(B);
  Qe(() => {
    fe && L(d, (k) => {
  ...
  const Re = (k) => /* @__PURE__ */ Kt.createElement(Kt.Fragment, null, d.map((G, q) => {
...
var G0 = 1;
function C0(e, { key: n, keys: t = n }, r) {
  if (t === null) {
...
function H0(e, n) {
  const [t, r] = Ze(!1), o = Z(), i = N.fun(e) && e, s = i ? i() : {}, { to: a = {}, from: u = {}, ..._ } = s, c = i ? n : e, [l, f] = br(() => ({ from: u, ..._ }), []);
  return Qe(() => {
    const T = o.current, {
      root: d,
      once: h,
    ...
    if (!T || h && t || typeof IntersectionObserver > "u")
      return;
    const b = /* @__PURE__ */ new WeakMap(), g = () => (a && f.start(a), r(!0), h ? void 0 : () => {
      u && f.start(u), r(!1);
    }), I = (H) => {
      H.forEach((M) => {
        const K = b.get(M.target);
        if (M.isIntersecting !== !!K)
          if (M.isIntersecting) {
            const w = g();
            N.fun(w) ? b.set(M.target, w) : p.unobserve(M.target);
          } else
            K && (K(), b.delete(M.target));
      });
    }, p = new IntersectionObserver(I, {
      root: d && d.current || void 0,
      threshold: typeof m == "number" || Array.isArray(m) ? m : y0[m],
      ...O
    });
    return p.observe(T), () => p.unobserve(T);
  }, [c]), i ? [o, l] : [o, t];
}
function P0({ children: e, ...n }) {
  return e(br(n));
}
function w0({
  items: e,
...
var Hs = class extends Us {
  ...
  _get() {
    const e = N.arr(this.source) ? this.source.map(ze) : We(ze(this.source));
    return this.calc(...e);
  }
  _start() {
...
function Fl(e) {
  return !e.size || Array.from(e).every(k0);
}
function ia(e) {
...
var x0 = (e, ...n) => new Hs(e, n), L0 = (e, ...n) => (gm(), new Hs(e, n));
dn.assign({
  createStringInterpolator: bm,
  to: (e, n) => new Hs(e, n)
});
var B0 = Mo.advance, Fm = /^--/;
function j0(e, n) {
...
var Wr = {
  ...
  strokeOpacity: !0,
  strokeWidth: !0
}, V0 = (e, n) => e + n.charAt(0).toUpperCase() + n.substring(1), W0 = ["Webkit", "Ms", "Moz", "O"];
Wr = Object.keys(Wr).reduce((e, n) => (W0.forEach((t) => e[V0(t, n)] = e[n]), e), Wr);
var X0 = /^(matrix|translate|scale|rotate|skew)/, Y0 = /^(translate)/, K0 = /^(rotate|skew)/, sa = (e, n) => N.num(e) && e !== 0 ? e + n : e, Oi = (e, n) => N.arr(e) ? e.every((t) => Oi(t, n)) : N.num(e) ? e === n : parseFloat(e) === n, $0 = class extends Gs {
  constructor({ x: e, y: n, z: t, ...r }) {
    ...
    (e || n || t) && (o.push([e || 0, n || 0, t || 0]), i.push((s) => [
      ...
      if (a === "transform")
        ...
        if (delete r[a], N.und(s))
          return;
        const u = Y0.test(a) ? "px" : K0.test(a) ? "deg" : "";
        o.push(We(s)), i.push(
          a === "rotate3d" ? ([_, c, l, f]) => [
            `rotate3d(${_},${c},${l},${sa(f, u)})`,
            Oi(f, 0)
          ] : (_) => [
    ...
    }), o.length && (r.transform = new z0(o, i)), super(r);
  }
}, z0 = class extends Tm {
  constructor(e, n) {
...
`, nS = Ie.h2`
  color: ${({ theme: e }) => e.light};
`, tS = Qn(() => {
  const e = es(), n = e.getActiveTab(), { spring: t, animatedDiv: r } = Z0(), o = Nt(), { openFile: i, saveFile: s } = mh(), a = mA(), u = !e.isAllowedToExecute(), _ = yt(), { isSignInOpened: c, ModalComponents: l } = _.state, f = () => {
    o.tabs.createTab();
  }, T = (d) => () => {
    _.update({
      isSignInOpened: d
  ...
  return /* @__PURE__ */ tn(eS, { as: r, style: t, children: [
    /* @__PURE__ */ V(
      uA,
      {
        runCode: a,
...
}), xS = () => /* @__PURE__ */ V(hu, { children: /* @__PURE__ */ V(tS, {}) });
class rS {
  constructor(n) {
    bt(this), this.state = n, this.getters = n.getters, this.actions = n.actions, this.codeRunner = new hA(n);
  }
}
class oS {
  constructor() {
    this.activeKey = "", this.content = [], this.theme = "vs-dark", this.fontSize = 20, this.tabSize = 4, this.customBackground = "#3d3d3d", this.customColor = "#3d3d3d", this.isStorageDisabled = !1, this.executeMessages = [], bt(this);
    const n = new Kd(this.isStorageDisabled);
    this.storage = n, this.getters = new rA(this), this.actions = new tA(this), this.services = new rS(this), this.theme = n.get("EDITOR_THEME", "vs-dark"), this.fontSize = Number(
    ...
    if (this.executeMessages = n.get(
      ...
      r.lang = iA, r.content = oA;
    }
    this.content = [...this.content, ...t], this.activeKey = this.content[0].key;
  }
}
const Rr = zi({}), LS = ({ children: e }) => {
  const n = new oS();
  return /* @__PURE__ */ V(Rr.Provider, { value: n, children: e });
}, Vm = zi({}), BS = ({ children: e, SignIn: n }) => {
  const t = it(
    () => ({
      isSettingsOpened: !1,
      isHtmlPreviewOpened: !1,
  ...
  return /* @__PURE__ */ V(Vm.Provider, { value: a, children: e });
}, iS = () => {
  const e = cd();
...
function Wm(e, n, t) {
  ...
  }), e.__c.__H = null), (e = sS({}, e)).__c != null && (e.__c.__P === t && (e.__c.__P = n), e.__c = null), e.__k = e.__k && e.__k.map(function(r) {
    return Wm(r, n, t);
  })), e;
}
function Xm(e, n, t) {
...
var uS = typeof Symbol < "u" && Symbol.for && Symbol.for("react.element") || 60103, _S = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, lS = /^on(Ani|Tra|Tou|BeforeInp|Compo)/, cS = /[A-Z0-9]/g, dS = typeof document < "u", hS = function(e) {
...
F.event = function(e) {
  return Jl && (e = Jl(e)), e.persist = mS, e.isPropagationStopped = fS, e.isDefaultPrevented = pS, e.nativeEvent = e;
};
var TS = { enumerable: !1, configurable: !0, get: function() {
  return this.class;
} }, ql = F.vnode;
F.vnode = function(e) {
  typeof e.type == "string" && function(n) {
    ...
    for (var i in t) {
      var s = t[i];
      if (!(i === "value" && "defaultValue" in t && s == null || dS && i === "children" && r === "noscript" || i === "class" || i === "className")) {
        var a = i.toLowerCase();
        i === "defaultValue" && "value" in t && t.value == null ? i = "value" : i === "download" && s === !0 ? s = "" : a === "ondoubleclick" ? i = "ondblclick" : a !== "onchange" || r !== "input" && r !== "textarea" || hS(t.type) ? a === "onfocus" ? i = "onfocusin" : a === "onblur" ? i = "onfocusout" : lS.test(i) ? i = a : r.indexOf("-") === -1 && _S.test(i) ? i = i.replace(cS, "-$&").toLowerCase() : s === null && (s = void 0) : a = i = "oninput", a === "oninput" && o[i = a] && (i = "oninputCapture"), o[i] = s;
      }
    }
    ...
    })), t.class && !t.className ? (o.class = t.class, Object.defineProperty(o, "className", TS)) : (t.className && !t.class || t.class && t.className) && (o.class = o.className = t.className), n.props = o;
  }(e), e.$$typeof = uS, ql && ql(e);
};
var Ql = F.__r;
F.__r = function(e) {
  Ql && Ql(e), e.__c;
...
const jS = Jm(() => import("./editor-26064666.mjs").then((e) => e.e));
export {
  oS as $,
  hu as A,
  DS as B,
