...
import { G as m, i as v, E as y, U as C, u as I, a as T, b as _, p as F, t as w, D as R, c as V, A as G, d as z, e as W, f as U, I as i, g as q, R as N, h as E, s as c, w as h, j as g, o as Z, F as J, k as K, l as Q, m as X, n as Y, P as e0, q as t0, r as o0, M as r0, N as s0, H as n0, v as c0, T as a0 } from "./index-e4f5f8e7.mjs";
import "antd";
...
function v0(e) {
  if (!(v(e) && "base" in e && typeof e.base == "string" && "colors" in e && v(e.colors)))
    throw new Error(y.WrongJsonObject("ThemeObject"));
}
const w0 = () => {
  const e = C(), o = I(), { theme: r, customBackground: n, customColor: s } = T(), u = _();
  return F(() => {
    let a = 0;
    w.forEach(async (d) => {
      try {
        const p = await x0(`./themes/${d}.json`);
        v0(p), e?.editor.defineTheme(d, p);
      } catch {
        console.log(y.ThemeUpload(d));
      }
      a += 1, a === w.length && (u({ background: n, color: s }), e?.editor.setTheme(r), o.on());
    });
  }, [e]), o.val;
};
function x0(e) {
...
const b0 = ({ children: e }) => {
  const o = w0();
  return /* @__PURE__ */ t(R, { when: o, children: e });
}, y0 = () => {
  ...
  const e = i0(), o = z(), r = T0(), n = W("isTerminalOpened"), { spring: s, animatedDiv: u } = y0(), a = () => {
    o.toggle("isSettingsOpened");
  }, d = () => {
    o.toggle("isHtmlPreviewOpened");
  };
  return /* @__PURE__ */ l(U, { as: u, style: s, children: [
    /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ t(i, { onClick: r.find, children: /* @__PURE__ */ t(m0, {}) }),
      /* @__PURE__ */ t(i, { onClick: r.replace, children: /* @__PURE__ */ t(d0, {}) }),
      /* @__PURE__ */ t(i, { onClick: e, children: /* @__PURE__ */ t(g0, {}) }),
      /* @__PURE__ */ t(i, { onClick: n("terminal"), children: /* @__PURE__ */ t(h0, {}) }),
      /* @__PURE__ */ t(i, { onClick: n("test_cases"), children: /* @__PURE__ */ t(u0, {}) }),
      /* @__PURE__ */ t(i, { onClick: d, children: /* @__PURE__ */ t(q, {}) })
    ] }),
    /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ t(i, { onClick: a, children: /* @__PURE__ */ t(f0, {}) }),
      /* @__PURE__ */ t(i, { children: /* @__PURE__ */ t(O, { to: N.ABOUT, children: /* @__PURE__ */ t(p0, {}) }) })
    ] })
  ] });
}, E0 = () => /* @__PURE__ */ t(G, { children: /* @__PURE__ */ t(z0, {}) }), S = k({}), S0 = ({ children: e }) => {
  const r = E().get("EDITOR_HTML_PREVIEW", {
    html: "<h2>Hi! This is a realtime HTML editor.</h2>",
    css: "h2 {color: #C4CBDA;}",
    javascript: "// 😀"
  }), n = (d, p) => ({ ...d, ...p }), [s, u] = P(n, r), a = j(
    () => ({
      state: s,
      update: u
    }),
...
`, f = Z(({ lang: e }) => {
  const { theme: o, fontSize: r, tabSize: n } = T(), s = M();
  return /* @__PURE__ */ l(M0, { children: [
    /* @__PURE__ */ t(H0, { children: e }),
    /* @__PURE__ */ t(
      J,
      {
        theme: o,
...
`, P0 = () => {
  const { state: e } = M(), [o, r] = L(""), n = E(), s = X(() => {
    r(k0(e)), n.set("EDITOR_HTML_PREVIEW", e);
  }, 250);
  return b(() => {
    s();
  }, [e, s]), /* @__PURE__ */ t(H, { children: /* @__PURE__ */ t(
    "iframe",
    {
      srcDoc: o,
      title: "output",
...
`, A0 = () => {
  const e = z(), { isHtmlPreviewOpened: o } = e.state, r = A(() => {
  ...
  return /* @__PURE__ */ t(
    e0,
    {
      ...
      onClose: r,
      height: 750,
      children: /* @__PURE__ */ t(S0, { children: /* @__PURE__ */ l(j0, { children: [
        /* @__PURE__ */ l($0, { children: [
          /* @__PURE__ */ t(f, { lang: "html" }),
          /* @__PURE__ */ t(f, { lang: "css" }),
          /* @__PURE__ */ t(f, { lang: "javascript" })
        ] }),
        /* @__PURE__ */ t(L0, { children: /* @__PURE__ */ t(P0, {}) })
      ] }) })
    }
  );
}, B0 = c.div`
  ${h("100%", "70px")};
  ${t0("space-between", "flex-start")};
  margin-bottom: 25px;
`, U0 = c(B0)`
  height: 45px;
  width: 60%;
...
`, D0 = B(() => import("./settings-f1158905.mjs")), O0 = c.div`
  ${h("100vw", "100vh")}
`, I0 = c.div`
  ${h("100%", "calc(100% - 45px)")};
  display: flex;
`, x = ({ SignIn: e }) => (l0(), /* @__PURE__ */ t(o0, { children: /* @__PURE__ */ t(b0, { children: /* @__PURE__ */ t(r0, { SignIn: e, children: /* @__PURE__ */ t(s0, { children: /* @__PURE__ */ l(O0, { children: [
  /* @__PURE__ */ t(n0, {}),
  ...
  /* @__PURE__ */ t(D, { fallback: null, children: /* @__PURE__ */ t(D0, {}) })
